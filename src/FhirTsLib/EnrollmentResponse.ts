 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/EnrollmentResponse
 */
export class EnrollmentResponse {
  ...
  */
  public setOutcome(newValue: string) {
    ...
    const idx = getValidValueIdx(EnrollmentResponseOutcome_list_ValidValues, newValue);
    if (idx >= 0) {
      this.outcome = EnrollmentResponseOutcome_list_ValidValues[idx];
    } else {
      throw new Error("Unknown outcome of " + newValue);
    }
  }
  
  public getEnrollmentResponseOutcomeValidValues(): string[] {
    return EnrollmentResponseOutcome_list_ValidValues;
  }
