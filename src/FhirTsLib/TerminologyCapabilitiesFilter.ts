...
export class TerminologyCapabilitiesFilter {
  ...
  */
  ...
  /**
  * Gets the current value of field _op if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public get_opOrElse(defaultValue: Element[]): Element[] {
      if (this._op == undefined || this._op == null ) { return defaultValue; }
      return this._op;
  }
