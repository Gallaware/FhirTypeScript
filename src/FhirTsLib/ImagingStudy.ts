...
export class ImagingStudy {
  ...
  */
  ...
  /**
  * Removes all elements from the array modality, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteModalityAll(): Coding[] {
    if (typeof(this.modality) !== 'undefined') {
       const oldArray = this.modality;
       delete this.modality;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array modality, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteModalityBySplice(start: number, deleteCount?: number): Coding[] {
    if (typeof(this.modality) !== 'undefined') {
       return this.modality.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field modality.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field modality if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getModalityOrElse(defaultValue: Coding[]): Coding[] {
      if (this.modality == undefined || this.modality == null ) { return defaultValue; }
      return this.modality;
  }
  ...
  */
  ...
  /**
  * Gets the current value of field started.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  /**
  * Removes all elements from the array interpreter, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteInterpreterAll(): Reference[] {
    if (typeof(this.interpreter) !== 'undefined') {
       const oldArray = this.interpreter;
       delete this.interpreter;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array interpreter, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteInterpreterBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.interpreter) !== 'undefined') {
       return this.interpreter.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field interpreter.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field interpreter if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getInterpreterOrElse(defaultValue: Reference[]): Reference[] {
      if (this.interpreter == undefined || this.interpreter == null ) { return defaultValue; }
      return this.interpreter;
  }
  ...
  */
  ...
  /**
  * Removes all elements from the array procedureCode, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteProcedureCodeAll(): CodeableConcept[] {
    if (typeof(this.procedureCode) !== 'undefined') {
       const oldArray = this.procedureCode;
       delete this.procedureCode;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array procedureCode, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteProcedureCodeBySplice(start: number, deleteCount?: number): CodeableConcept[] {
    if (typeof(this.procedureCode) !== 'undefined') {
       return this.procedureCode.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field procedureCode.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field procedureCode if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getProcedureCodeOrElse(defaultValue: CodeableConcept[]): CodeableConcept[] {
      if (this.procedureCode == undefined || this.procedureCode == null ) { return defaultValue; }
      return this.procedureCode;
  }
  ...
  */
  ...
  /**
  * Removes all elements from the array series, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteSeriesAll(): ImagingStudySeries[] {
    if (typeof(this.series) !== 'undefined') {
       const oldArray = this.series;
       delete this.series;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array series, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteSeriesBySplice(start: number, deleteCount?: number): ImagingStudySeries[] {
    if (typeof(this.series) !== 'undefined') {
       return this.series.splice(start, deleteCount);
    }
    return [];
  }
  ...
  * @returns the value or the parameter value
  */
  public getSeriesOrElse(defaultValue: ImagingStudySeries[]): ImagingStudySeries[] {
