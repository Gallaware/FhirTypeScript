...
import { Extension, TestReportAction2 } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestReport_Teardown
 */
export class TestReportTeardown {
  ...
  protected action?: TestReportAction2[];
  ...
  */
  ...
  public addAction(newValue: TestReportAction2) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteActionAll(): TestReportAction2[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteActionBySplice(start: number, deleteCount?: number): TestReportAction2[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getActionOrElse(defaultValue: TestReportAction2[]): TestReportAction2[] {
