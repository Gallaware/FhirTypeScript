...
import { DocumentReferenceRelatesToCode_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/DocumentReference_RelatesTo
 */
export class DocumentReferenceRelatesTo {
  ...
  */
  public setCode(newValue: string) {
    ...
    const idx = getValidValueIdx(DocumentReferenceRelatesToCode_list_ValidValues, newValue);
    if (idx >= 0) {
      this.code = DocumentReferenceRelatesToCode_list_ValidValues[idx];
    } else {
      throw new Error("Unknown code of " + newValue);
    }
  }
  
  public getDocumentReferenceRelatesToCodeValidValues(): string[] {
    return DocumentReferenceRelatesToCode_list_ValidValues;
  }
