...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_DATE, REGEX_TITLE, REGEX_CONFIDENTIALITY } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, CompositionAttester, CompositionEvent, CompositionRelatesTo, CompositionSection, Element, Extension, Identifier, Meta, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './FhirType';
import { CompositionStatus_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Composition
 */
export class Composition {
   ...
   * Field access restricted because there are specific valid values.
   */
  protected confidentiality?: string;
  ...
  protected attester?: CompositionAttester[];
  ...
  protected relatesTo?: CompositionRelatesTo[];
  ...
  protected event?: CompositionEvent[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(CompositionStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = CompositionStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getCompositionStatusValidValues(): string[] {
  ...
  * that should be caught.
  */
  public setConfidentiality(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.confidentiality) !== 'undefined') {
         delete this.confidentiality;
      }
      return;
    }
    
    if (REGEX_CONFIDENTIALITY.test(newValue)) {
      this.confidentiality = newValue
    } else {
      throw new Error("Invalid value pattern for confidentiality of " + newValue);
    }
  }
  
  public getConfidentialityPattern(): string {
  ...
  public addAttester(newValue: CompositionAttester) {
    if (typeof(newValue) === 'undefined') {
  ...
  public addEvent(newValue: CompositionEvent) {
    if (typeof(newValue) === 'undefined') {
