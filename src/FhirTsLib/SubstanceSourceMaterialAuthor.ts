...
export class SubstanceSourceMaterialAuthor {
  ...
  */
  ...
  /**
  * Gets the current value of field authorDescription.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field authorDescription if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getAuthorDescriptionOrElse(defaultValue: string): string {
      if (this.authorDescription == undefined || this.authorDescription == null ) { return defaultValue; }
      return this.authorDescription;
  }
