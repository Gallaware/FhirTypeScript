...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_ONSETDATETIME, REGEX_ONSETSTRING, REGEX_ABATEMENTDATETIME, REGEX_ABATEMENTSTRING, REGEX_RECORDEDDATE } from '../FhirTsLibValidation/FhirRegex';
import { Age, Annotation, CodeableConcept, ConditionEvidence, ConditionStage, Element, Extension, Identifier, Meta, Narrative, Period, Range, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Condition
 */
export class Condition {
   ...
   * Field access restricted because there are specific valid values.
   */
  protected onsetDateTime?: string;
   ...
   * Field access restricted because there are specific valid values.
   */
  protected abatementDateTime?: string;
   ...
   * Field access restricted because there are specific valid values.
   */
  protected abatementString?: string;
   ...
   */
  @Type(() => ConditionStage)
  protected stage?: ConditionStage[];
  ...
  protected evidence?: ConditionEvidence[];
  ...
  * that should be caught.
  */
  public setOnsetDateTime(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.onsetDateTime) !== 'undefined') {
         delete this.onsetDateTime;
      }
      return;
    }
    
    if (REGEX_ONSETDATETIME.test(newValue)) {
      this.onsetDateTime = newValue
    } else {
      throw new Error("Invalid value pattern for onsetDateTime of " + newValue);
    }
  }
  
  public getOnsetDateTimePattern(): string {
  ...
  * that should be caught.
  */
  public setAbatementDateTime(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.abatementDateTime) !== 'undefined') {
         delete this.abatementDateTime;
      }
      return;
    }
    
    if (REGEX_ABATEMENTDATETIME.test(newValue)) {
      this.abatementDateTime = newValue
    } else {
      throw new Error("Invalid value pattern for abatementDateTime of " + newValue);
    }
  }
  
  public getAbatementDateTimePattern(): string {
    return REGEX_ABATEMENTDATETIME.source;
  }
  
  /**
  * Gets the current value of field abatementDateTime.
  * @returns the value  or undefined
  */
  ...
  * that should be caught.
  */
  public setAbatementString(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.abatementString) !== 'undefined') {
         delete this.abatementString;
      }
      return;
    }
    
    if (REGEX_ABATEMENTSTRING.test(newValue)) {
      this.abatementString = newValue
    } else {
      throw new Error("Invalid value pattern for abatementString of " + newValue);
    }
  }
  
  public getAbatementStringPattern(): string {
    return REGEX_ABATEMENTSTRING.source;
  }
  
  /**
  * Gets the current value of field abatementString.
  * @returns the value  or undefined
  */
  public getAbatementString(): string | undefined {
  ...
  */
  ...
  public addStage(newValue: ConditionStage) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array stage, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteStageAll(): ConditionStage[] {
    if (typeof(this.stage) !== 'undefined') {
       const oldArray = this.stage;
       delete this.stage;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array stage, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteStageBySplice(start: number, deleteCount?: number): ConditionStage[] {
    if (typeof(this.stage) !== 'undefined') {
       return this.stage.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field stage.
  * @returns the value  or undefined
  */
  ...
  /**
  * Removes all elements from the array evidence, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteEvidenceAll(): ConditionEvidence[] {
    if (typeof(this.evidence) !== 'undefined') {
       const oldArray = this.evidence;
       delete this.evidence;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array evidence, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteEvidenceBySplice(start: number, deleteCount?: number): ConditionEvidence[] {
    if (typeof(this.evidence) !== 'undefined') {
       return this.evidence.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field evidence.
  * @returns the value  or undefined
  */
