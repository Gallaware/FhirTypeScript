 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/InsurancePlan
 */
export class InsurancePlan {
  ...
  protected contact?: InsurancePlanContact[];
  ...
  protected coverage?: InsurancePlanCoverage[];
  ...
  protected plan?: InsurancePlanPlan[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(InsurancePlanStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = InsurancePlanStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getInsurancePlanStatusValidValues(): string[] {
  ...
  */
  ...
  public addCoverage(newValue: InsurancePlanCoverage) {
    if (typeof(newValue) === 'undefined') {
