 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/AdverseEvent
 */
export class AdverseEvent {
  ...
  /**
   * Whether the event actually happened, or just had the potential to. Note that this is independent of
   * whether anyone was affected or harmed or how severely.
   * Field access restricted because there are specific valid values.
   */
  protected actuality?: string;
  ...
  /**
   * Includes information about the reaction that occurred as a result of exposure to a substance (for
   * example, a drug or a chemical).
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Reference)
  protected resultingCondition?: Reference[];
  ...
  /**
   * Parties that may or should contribute or have contributed information to the adverse event, which
   * can consist of one or more activities.  Such information includes information leading to the
   * decision to perform the activity and how to perform the activity (e.g. consultant), information
   * that the activity itself seeks to reveal (e.g. informant of clinical history), or information
  ...
  protected suspectEntity?: AdverseEventSuspectEntity[];
   ...
   */
  @Type(() => Reference)
  protected subjectMedicalHistory?: Reference[];
   ...
   */
  @Type(() => Reference)
  protected referenceDocument?: Reference[];
  ...
  * that should be caught.
  */
  public setActuality(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.actuality) !== 'undefined') {
         delete this.actuality;
      }
      return;
    }
    
    const idx = getValidValueIdx(AdverseEventActuality_list_ValidValues, newValue);
    if (idx >= 0) {
      this.actuality = AdverseEventActuality_list_ValidValues[idx];
    } else {
      throw new Error("Unknown actuality of " + newValue);
    }
  }
  
  public getAdverseEventActualityValidValues(): string[] {
  ...
  */
  ...
  /**
  * Gets the current value of field actuality if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getActualityOrElse(defaultValue: string): string {
      if (this.actuality == undefined || this.actuality == null ) { return defaultValue; }
      return this.actuality;
  }
  ...
  * that should be caught.
  */
  public setDetected(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.detected) !== 'undefined') {
         delete this.detected;
      }
      return;
    }
    
    if (REGEX_DETECTED.test(newValue)) {
      this.detected = newValue
    } else {
      throw new Error("Invalid value pattern for detected of " + newValue);
    }
  }
  
  public getDetectedPattern(): string {
  ...
  */
  ...
  /**
  * Gets the current value of field detected if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getDetectedOrElse(defaultValue: string): string {
      if (this.detected == undefined || this.detected == null ) { return defaultValue; }
      return this.detected;
  }
  ...
  * that should be caught.
  */
  public setRecordedDate(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.recordedDate) !== 'undefined') {
         delete this.recordedDate;
      }
      return;
    }
    
    if (REGEX_RECORDEDDATE.test(newValue)) {
      this.recordedDate = newValue
    } else {
      throw new Error("Invalid value pattern for recordedDate of " + newValue);
    }
  }
  
  public getRecordedDatePattern(): string {
  ...
  */
  ...
  public addResultingCondition(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field resultingCondition if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getResultingConditionOrElse(defaultValue: Reference[]): Reference[] {
      if (this.resultingCondition == undefined || this.resultingCondition == null ) { return defaultValue; }
      return this.resultingCondition;
  }
  ...
  */
  ...
  public addSuspectEntity(newValue: AdverseEventSuspectEntity) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field suspectEntity if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getSuspectEntityOrElse(defaultValue: AdverseEventSuspectEntity[]): AdverseEventSuspectEntity[] {
      if (this.suspectEntity == undefined || this.suspectEntity == null ) { return defaultValue; }
      return this.suspectEntity;
  }

  public addSubjectMedicalHistory(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field subjectMedicalHistory if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getSubjectMedicalHistoryOrElse(defaultValue: Reference[]): Reference[] {
      if (this.subjectMedicalHistory == undefined || this.subjectMedicalHistory == null ) { return defaultValue; }
      return this.subjectMedicalHistory;
  }

  public addReferenceDocument(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field referenceDocument if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getReferenceDocumentOrElse(defaultValue: Reference[]): Reference[] {
      if (this.referenceDocument == undefined || this.referenceDocument == null ) { return defaultValue; }
      return this.referenceDocument;
  }

  public addStudy(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field study if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getStudyOrElse(defaultValue: Reference[]): Reference[] {
      if (this.study == undefined || this.study == null ) { return defaultValue; }
      return this.study;
  }
