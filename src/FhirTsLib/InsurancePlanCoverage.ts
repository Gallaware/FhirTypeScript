...
import { CodeableConcept, Extension, InsurancePlanBenefit, Reference } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/InsurancePlan_Coverage
 */
export class InsurancePlanCoverage {
  ...
  protected benefit?: InsurancePlanBenefit[];
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteBenefitAll(): InsurancePlanBenefit[] {
    if (typeof(this.benefit) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteBenefitBySplice(start: number, deleteCount?: number): InsurancePlanBenefit[] {
    if (typeof(this.benefit) !== 'undefined') {
