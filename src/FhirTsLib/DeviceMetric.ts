...
import { CodeableConcept, DeviceMetricCalibration, Element, Extension, Identifier, Meta, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, Timing } from './index';
import { DeviceMetricOperationalStatus_list_ValidValues, DeviceMetricColor_list_ValidValues, DeviceMetricCategory_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/DeviceMetric
 */
export class DeviceMetric {
  ...
  /**
   * Unique instance identifiers assigned to a device by the device or gateway software, manufacturers,
   ...
   * Field access restricted because there are specific valid values.
   */
  protected operationalStatus?: string;
  ...
  /**
   * Describes the color representation for the metric. This is often used to aid clinicians to track
   * and identify parameter types by color. In practice, consider a Patient Monitor that has ECG/HR and
   * Pleth for example; the parameters are displayed in different characteristic colors, such as
  ...
  protected calibration?: DeviceMetricCalibration[];
  ...
  * that should be caught.
  */
  public setOperationalStatus(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.operationalStatus) !== 'undefined') {
         delete this.operationalStatus;
      }
      return;
    }
    
    const idx = getValidValueIdx(DeviceMetricOperationalStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.operationalStatus = DeviceMetricOperationalStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown operationalStatus of " + newValue);
    }
  }
  
  public getDeviceMetricOperationalStatusValidValues(): string[] {
    return DeviceMetricOperationalStatus_list_ValidValues;
  }
  
  /**
  * Gets the current value of field operationalStatus.
  * @returns the value  or undefined
  */
  public getOperationalStatus(): string | undefined {
      return this.operationalStatus;
  }

  /**
  * Gets the current value of field operationalStatus if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getOperationalStatusOrElse(defaultValue: string): string {
      if (this.operationalStatus == undefined || this.operationalStatus == null ) { return defaultValue; }
      return this.operationalStatus;
  }
  ...
  */
  public setColor(newValue: string) {
    ...
    const idx = getValidValueIdx(DeviceMetricColor_list_ValidValues, newValue);
    if (idx >= 0) {
      this.color = DeviceMetricColor_list_ValidValues[idx];
    } else {
      throw new Error("Unknown color of " + newValue);
    }
  }
  
  public getDeviceMetricColorValidValues(): string[] {
    return DeviceMetricColor_list_ValidValues;
  }
  ...
  */
  public setCategory(newValue: string) {
    ...
    const idx = getValidValueIdx(DeviceMetricCategory_list_ValidValues, newValue);
    if (idx >= 0) {
      this.category = DeviceMetricCategory_list_ValidValues[idx];
    } else {
      throw new Error("Unknown category of " + newValue);
    }
  }
  
  public getDeviceMetricCategoryValidValues(): string[] {
    return DeviceMetricCategory_list_ValidValues;
  }
  ...
  */
  ...
  public addCalibration(newValue: DeviceMetricCalibration) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array calibration, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteCalibrationAll(): DeviceMetricCalibration[] {
    if (typeof(this.calibration) !== 'undefined') {
       const oldArray = this.calibration;
       delete this.calibration;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array calibration, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteCalibrationBySplice(start: number, deleteCount?: number): DeviceMetricCalibration[] {
    if (typeof(this.calibration) !== 'undefined') {
       return this.calibration.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field calibration.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field calibration if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getCalibrationOrElse(defaultValue: DeviceMetricCalibration[]): DeviceMetricCalibration[] {
      if (this.calibration == undefined || this.calibration == null ) { return defaultValue; }
      return this.calibration;
  }
