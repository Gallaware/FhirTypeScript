 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/MedicinalProductContraindication
 */
export class MedicinalProductContraindication {
  ...
  /**
   * Information about the use of the medicinal product in relation to other therapies as part of the
   * indication.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Reference)
  protected therapeuticIndication?: Reference[];
  ...
  protected otherTherapy?: MedicinalProductContraindicationOtherTherapy[];
  ...
  */
  ...
  public addTherapeuticIndication(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array therapeuticIndication, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteTherapeuticIndicationAll(): Reference[] {
    if (typeof(this.therapeuticIndication) !== 'undefined') {
       const oldArray = this.therapeuticIndication;
       delete this.therapeuticIndication;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array therapeuticIndication, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteTherapeuticIndicationBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.therapeuticIndication) !== 'undefined') {
       return this.therapeuticIndication.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field therapeuticIndication.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field therapeuticIndication if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getTherapeuticIndicationOrElse(defaultValue: Reference[]): Reference[] {
      if (this.therapeuticIndication == undefined || this.therapeuticIndication == null ) { return defaultValue; }
      return this.therapeuticIndication;
  }

  public addOtherTherapy(newValue: MedicinalProductContraindicationOtherTherapy) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteOtherTherapyAll(): MedicinalProductContraindicationOtherTherapy[] {
    if (typeof(this.otherTherapy) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteOtherTherapyBySplice(start: number, deleteCount?: number): MedicinalProductContraindicationOtherTherapy[] {
    if (typeof(this.otherTherapy) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getOtherTherapyOrElse(defaultValue: MedicinalProductContraindicationOtherTherapy[]): MedicinalProductContraindicationOtherTherapy[] {
