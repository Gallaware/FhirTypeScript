 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/DocumentManifest
 */
export class DocumentManifest {
  ...
  /**
   * Identifies who is the author of the manifest. Manifest author is not necessarly the author of the
   * references included.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Reference)
  ...
  protected related?: DocumentManifestRelated[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(DocumentManifestStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = DocumentManifestStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getDocumentManifestStatusValidValues(): string[] {
  ...
  */
  ...
  public addContent(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
