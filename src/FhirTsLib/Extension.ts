...
import { REGEX_ID, REGEX_URL, REGEX_VALUEBASE64BINARY, REGEX_VALUECANONICAL, REGEX_VALUECODE, REGEX_VALUEDATE, REGEX_VALUEDATETIME, REGEX_VALUEID, REGEX_VALUEINSTANT, REGEX_VALUEMARKDOWN, REGEX_VALUEOID, REGEX_VALUESTRING, REGEX_VALUETIME, REGEX_VALUEURI, REGEX_VALUEURL, REGEX_VALUEUUID } from '../FhirTsLibValidation/FhirRegex';
import { Address, Age, Annotation, Attachment, CodeableConcept, Coding, ContactDetail, ContactPoint, Contributor, Count, DataRequirement, Distance, Dosage, Duration, Element, Expression, HumanName, Identifier, Meta, Money, ParameterDefinition, Period, Quantity, Range, Ratio, Reference, RelatedArtifact, SampledData, Signature, Timing, TriggerDefinition, UsageContext } from './FhirType';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Extension
 */
