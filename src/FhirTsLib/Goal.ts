...
export class Goal {
  ...
  */
  ...
  /**
  * Gets the current value of field lifecycleStatus.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  /**
  * Gets the current value of field startDate.
  * @returns the value  or undefined
  */
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteTargetAll(): GoalTarget[] {
    if (typeof(this.target) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteTargetBySplice(start: number, deleteCount?: number): GoalTarget[] {
    if (typeof(this.target) !== 'undefined') {
  ...
  */
  ...
  /**
  * Removes all elements from the array outcomeCode, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteOutcomeCodeAll(): CodeableConcept[] {
    if (typeof(this.outcomeCode) !== 'undefined') {
       const oldArray = this.outcomeCode;
       delete this.outcomeCode;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array outcomeCode, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteOutcomeCodeBySplice(start: number, deleteCount?: number): CodeableConcept[] {
    if (typeof(this.outcomeCode) !== 'undefined') {
       return this.outcomeCode.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field outcomeCode.
  * @returns the value  or undefined
  */
