...
export class Evidence {
  ...
  */
  ...
  /**
  * Removes all elements from the array exposureVariant, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteExposureVariantAll(): Reference[] {
    if (typeof(this.exposureVariant) !== 'undefined') {
       const oldArray = this.exposureVariant;
       delete this.exposureVariant;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array exposureVariant, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteExposureVariantBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.exposureVariant) !== 'undefined') {
       return this.exposureVariant.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field exposureVariant.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field exposureVariant if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getExposureVariantOrElse(defaultValue: Reference[]): Reference[] {
      if (this.exposureVariant == undefined || this.exposureVariant == null ) { return defaultValue; }
      return this.exposureVariant;
  }
  ...
  /**
  * Removes all elements from the array outcome, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteOutcomeAll(): Reference[] {
    if (typeof(this.outcome) !== 'undefined') {
       const oldArray = this.outcome;
       delete this.outcome;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array outcome, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteOutcomeBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.outcome) !== 'undefined') {
       return this.outcome.splice(start, deleteCount);
    }
    return [];
  }
  ...
  * @returns the value or the parameter value
  */
  public getOutcomeOrElse(defaultValue: Reference[]): Reference[] {
