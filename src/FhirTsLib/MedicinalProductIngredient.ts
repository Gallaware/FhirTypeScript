...
import { CodeableConcept, Element, Extension, Identifier, MedicinalProductIngredientSpecifiedSubstance, MedicinalProductIngredientSubstance, Meta, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/MedicinalProductIngredient
 */
export class MedicinalProductIngredient {
  ...
  protected specifiedSubstance?: MedicinalProductIngredientSpecifiedSubstance[];
  ...
  */
  ...
  public addSpecifiedSubstance(newValue: MedicinalProductIngredientSpecifiedSubstance) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array specifiedSubstance, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteSpecifiedSubstanceAll(): MedicinalProductIngredientSpecifiedSubstance[] {
    if (typeof(this.specifiedSubstance) !== 'undefined') {
       const oldArray = this.specifiedSubstance;
       delete this.specifiedSubstance;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array specifiedSubstance, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteSpecifiedSubstanceBySplice(start: number, deleteCount?: number): MedicinalProductIngredientSpecifiedSubstance[] {
    if (typeof(this.specifiedSubstance) !== 'undefined') {
       return this.specifiedSubstance.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field specifiedSubstance.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field specifiedSubstance if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getSpecifiedSubstanceOrElse(defaultValue: MedicinalProductIngredientSpecifiedSubstance[]): MedicinalProductIngredientSpecifiedSubstance[] {
      if (this.specifiedSubstance == undefined || this.specifiedSubstance == null ) { return defaultValue; }
      return this.specifiedSubstance;
  }
