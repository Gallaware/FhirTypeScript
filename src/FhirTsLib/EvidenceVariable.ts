 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/EvidenceVariable
 */
export class EvidenceVariable {
  /**
   ...
   * categorization grouping types of EvidenceVariables that can be useful for filtering and searching.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => CodeableConcept)
  ...
  protected characteristic?: EvidenceVariableCharacteristic[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(EvidenceVariableStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = EvidenceVariableStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getEvidenceVariableStatusValidValues(): string[] {
    return EvidenceVariableStatus_list_ValidValues;
  }
  ...
  */
  public setType(newValue: string) {
    ...
    const idx = getValidValueIdx(EvidenceVariableType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.type = EvidenceVariableType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown type of " + newValue);
    }
  }
  
  public getEvidenceVariableTypeValidValues(): string[] {
    return EvidenceVariableType_list_ValidValues;
  }
  ...
  */
  ...
  public addCharacteristic(newValue: EvidenceVariableCharacteristic) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteCharacteristicAll(): EvidenceVariableCharacteristic[] {
    if (typeof(this.characteristic) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteCharacteristicBySplice(start: number, deleteCount?: number): EvidenceVariableCharacteristic[] {
    if (typeof(this.characteristic) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getCharacteristic(): EvidenceVariableCharacteristic[] | undefined {
  ...
  * @returns the value or the parameter value
  */
  public getCharacteristicOrElse(defaultValue: EvidenceVariableCharacteristic[]): EvidenceVariableCharacteristic[] {
