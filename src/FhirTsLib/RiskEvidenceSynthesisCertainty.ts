...
import { Annotation, CodeableConcept, Extension, RiskEvidenceSynthesisCertaintySubcomponent } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/RiskEvidenceSynthesis_Certainty
 */
export class RiskEvidenceSynthesisCertainty {
  /**
  ...
  protected certaintySubcomponent?: RiskEvidenceSynthesisCertaintySubcomponent[];
  ...
  */
  ...
  public addCertaintySubcomponent(newValue: RiskEvidenceSynthesisCertaintySubcomponent) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getCertaintySubcomponentOrElse(defaultValue: RiskEvidenceSynthesisCertaintySubcomponent[]): RiskEvidenceSynthesisCertaintySubcomponent[] {
