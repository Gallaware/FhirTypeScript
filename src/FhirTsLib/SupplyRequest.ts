...
export class SupplyRequest {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteParameterAll(): SupplyRequestParameter[] {
    if (typeof(this.parameter) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteParameterBySplice(start: number, deleteCount?: number): SupplyRequestParameter[] {
    if (typeof(this.parameter) !== 'undefined') {
  ...
  */
  ...
  /**
  * Removes all elements from the array supplier, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteSupplierAll(): Reference[] {
    if (typeof(this.supplier) !== 'undefined') {
       const oldArray = this.supplier;
       delete this.supplier;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array supplier, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteSupplierBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.supplier) !== 'undefined') {
       return this.supplier.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field supplier.
  * @returns the value  or undefined
  */
