...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_DATETIME } from '../FhirTsLibValidation/FhirRegex';
import { Attachment, CodeableConcept, ConsentPolicy, ConsentProvision, ConsentVerification, Element, Extension, Identifier, Meta, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './index';
import { ConsentStatus_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Consent
 */
export class Consent {
   ...
   */
  @Type(() => Reference)
  protected organization?: Reference[];
   ...
   */
  @Type(() => ConsentPolicy)
  protected policy?: ConsentPolicy[];
  ...
  protected verification?: ConsentVerification[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(ConsentStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = ConsentStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getConsentStatusValidValues(): string[] {
    return ConsentStatus_list_ValidValues;
  }
  ...
  */
  ...
  /**
  * Removes all elements from the array organization, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteOrganizationAll(): Reference[] {
    if (typeof(this.organization) !== 'undefined') {
       const oldArray = this.organization;
       delete this.organization;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array organization, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteOrganizationBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.organization) !== 'undefined') {
       return this.organization.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field organization.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  public addPolicy(newValue: ConsentPolicy) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deletePolicyAll(): ConsentPolicy[] {
    if (typeof(this.policy) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deletePolicyBySplice(start: number, deleteCount?: number): ConsentPolicy[] {
    if (typeof(this.policy) !== 'undefined') {
  ...
  */
  ...
  /**
  * Removes all elements from the array verification, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteVerificationAll(): ConsentVerification[] {
    if (typeof(this.verification) !== 'undefined') {
       const oldArray = this.verification;
       delete this.verification;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array verification, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteVerificationBySplice(start: number, deleteCount?: number): ConsentVerification[] {
    if (typeof(this.verification) !== 'undefined') {
       return this.verification.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field verification.
  * @returns the value  or undefined
  */
