...
import { REGEX_ID, REGEX_MESSAGE_000, REGEX_DETAIL } from '../FhirTsLibValidation/FhirRegex';
import { Element, Extension } from './index';
import { TestReportAssertResult_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestReport_Assert
 */
export class TestReportAssert {
  /**
  ...
  */
  public setResult(newValue: string) {
    ...
    const idx = getValidValueIdx(TestReportAssertResult_list_ValidValues, newValue);
    if (idx >= 0) {
      this.result = TestReportAssertResult_list_ValidValues[idx];
    } else {
      throw new Error("Unknown result of " + newValue);
    }
  }
  
  public getTestReportAssertResultValidValues(): string[] {
    return TestReportAssertResult_list_ValidValues;
  }
