 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Practitioner
 */
export class Practitioner {
   ...
   * ork addresses are not typically entered in this property as they are usually role dependent.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Address)
  ...
  protected qualification?: PractitionerQualification[];
  ...
  */
  public setGender(newValue: string) {
    ...
    const idx = getValidValueIdx(PractitionerGender_list_ValidValues, newValue);
    if (idx >= 0) {
      this.gender = PractitionerGender_list_ValidValues[idx];
    } else {
      throw new Error("Unknown gender of " + newValue);
    }
  }
  
  public getPractitionerGenderValidValues(): string[] {
  ...
  */
  ...
  public addQualification(newValue: PractitionerQualification) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field qualification if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getQualificationOrElse(defaultValue: PractitionerQualification[]): PractitionerQualification[] {
      if (this.qualification == undefined || this.qualification == null ) { return defaultValue; }
      return this.qualification;
  }
