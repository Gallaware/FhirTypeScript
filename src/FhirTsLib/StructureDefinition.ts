...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_URL, REGEX_VERSION, REGEX_NAME, REGEX_TITLE, REGEX_DATE, REGEX_PUBLISHER, REGEX_DESCRIPTION, REGEX_PURPOSE, REGEX_COPYRIGHT, REGEX_TYPE_001, REGEX_BASEDEFINITION } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, Coding, ContactDetail, Element, Extension, Identifier, Meta, Narrative, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, StructureDefinitionContext, StructureDefinitionDifferential, StructureDefinitionMapping, StructureDefinitionSnapshot, UsageContext } from './index';
import { StructureDefinitionStatus_list_ValidValues, StructureDefinitionFhirVersion_list_ValidValues, StructureDefinitionKind_list_ValidValues, StructureDefinitionDerivation_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/StructureDefinition
 */
export class StructureDefinition {
  ...
  /**
   * A set of key words or terms from external terminologies that may be used to assist with indexing
   * and searching of templates nby describing the use of this structure definition, or the content it
   * describes.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Coding)
  protected keyword?: Coding[];
  ...
  protected mapping?: StructureDefinitionMapping[];
  ...
  protected context?: StructureDefinitionContext[];
   ...
   * Field access restricted because there are specific valid values.
   */
  protected contextInvariant?: string[];
   ...
   */
  @Type(() => Element)
  protected _contextInvariant?: Element[];
   ...
   * Field access restricted because there are specific valid values.
   */
  protected baseDefinition?: string;

  /**
   * How the type relates to the baseDefinition.
   * Field access restricted because there are specific valid values.
   */
  protected derivation?: string;
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(StructureDefinitionStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = StructureDefinitionStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getStructureDefinitionStatusValidValues(): string[] {
    return StructureDefinitionStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addKeyword(newValue: Coding) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array keyword, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteKeywordAll(): Coding[] {
    if (typeof(this.keyword) !== 'undefined') {
       const oldArray = this.keyword;
       delete this.keyword;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array keyword, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteKeywordBySplice(start: number, deleteCount?: number): Coding[] {
    if (typeof(this.keyword) !== 'undefined') {
       return this.keyword.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field keyword.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field keyword if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getKeywordOrElse(defaultValue: Coding[]): Coding[] {
      if (this.keyword == undefined || this.keyword == null ) { return defaultValue; }
      return this.keyword;
  }
  ...
  */
  public setFhirVersion(newValue: string) {
    ...
    const idx = getValidValueIdx(StructureDefinitionFhirVersion_list_ValidValues, newValue);
    if (idx >= 0) {
      this.fhirVersion = StructureDefinitionFhirVersion_list_ValidValues[idx];
    } else {
      throw new Error("Unknown fhirVersion of " + newValue);
    }
  }
  
  public getStructureDefinitionFhirVersionValidValues(): string[] {
    return StructureDefinitionFhirVersion_list_ValidValues;
  }
  ...
  */
  ...
  public addMapping(newValue: StructureDefinitionMapping) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteMappingAll(): StructureDefinitionMapping[] {
    if (typeof(this.mapping) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteMappingBySplice(start: number, deleteCount?: number): StructureDefinitionMapping[] {
    if (typeof(this.mapping) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getMappingOrElse(defaultValue: StructureDefinitionMapping[]): StructureDefinitionMapping[] {
  ...
  */
  public setKind(newValue: string) {
    ...
    const idx = getValidValueIdx(StructureDefinitionKind_list_ValidValues, newValue);
    if (idx >= 0) {
      this.kind = StructureDefinitionKind_list_ValidValues[idx];
    } else {
      throw new Error("Unknown kind of " + newValue);
    }
  }
  
  public getStructureDefinitionKindValidValues(): string[] {
    return StructureDefinitionKind_list_ValidValues;
  }
  ...
  */
  ...
  public addContext(newValue: StructureDefinitionContext) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteContextAll(): StructureDefinitionContext[] {
    if (typeof(this.context) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteContextBySplice(start: number, deleteCount?: number): StructureDefinitionContext[] {
    if (typeof(this.context) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getContextOrElse(defaultValue: StructureDefinitionContext[]): StructureDefinitionContext[] {
      if (this.context == undefined || this.context == null ) { return defaultValue; }
      return this.context;
  }

  public addContextInvariant(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array contextInvariant, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteContextInvariantAll(): string[] {
    if (typeof(this.contextInvariant) !== 'undefined') {
       const oldArray = this.contextInvariant;
       delete this.contextInvariant;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array contextInvariant, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteContextInvariantBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.contextInvariant) !== 'undefined') {
       return this.contextInvariant.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field contextInvariant.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field contextInvariant if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getContextInvariantOrElse(defaultValue: string[]): string[] {
      if (this.contextInvariant == undefined || this.contextInvariant == null ) { return defaultValue; }
      return this.contextInvariant;
  }

  public add_contextInvariant(newValue: Element) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array _contextInvariant, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public delete_contextInvariantAll(): Element[] {
    if (typeof(this._contextInvariant) !== 'undefined') {
       const oldArray = this._contextInvariant;
       delete this._contextInvariant;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array _contextInvariant, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public delete_contextInvariantBySplice(start: number, deleteCount?: number): Element[] {
    if (typeof(this._contextInvariant) !== 'undefined') {
       return this._contextInvariant.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field _contextInvariant.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field _contextInvariant if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public get_contextInvariantOrElse(defaultValue: Element[]): Element[] {
      if (this._contextInvariant == undefined || this._contextInvariant == null ) { return defaultValue; }
      return this._contextInvariant;
  }
  ...
  */
  public setType(newValue: string) {
    ...
    if (REGEX_TYPE_001.test(newValue)) {
      this.type = newValue
    } else {
  ...
  * that should be caught.
  */
  public setBaseDefinition(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.baseDefinition) !== 'undefined') {
         delete this.baseDefinition;
      }
      return;
    }
    
    if (REGEX_BASEDEFINITION.test(newValue)) {
      this.baseDefinition = newValue
    } else {
      throw new Error("Invalid value pattern for baseDefinition of " + newValue);
    }
  }
  
  public getBaseDefinitionPattern(): string {
    return REGEX_BASEDEFINITION.source;
  }
  
  /**
  * Gets the current value of field baseDefinition.
  * @returns the value  or undefined
  */
  public getBaseDefinition(): string | undefined {
      return this.baseDefinition;
  }

  /**
  * Gets the current value of field baseDefinition if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getBaseDefinitionOrElse(defaultValue: string): string {
      if (this.baseDefinition == undefined || this.baseDefinition == null ) { return defaultValue; }
      return this.baseDefinition;
  }
  ...
  * that should be caught.
  */
  public setDerivation(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.derivation) !== 'undefined') {
         delete this.derivation;
      }
      return;
    }
    
    const idx = getValidValueIdx(StructureDefinitionDerivation_list_ValidValues, newValue);
    if (idx >= 0) {
      this.derivation = StructureDefinitionDerivation_list_ValidValues[idx];
    } else {
      throw new Error("Unknown derivation of " + newValue);
    }
  }
  
  public getStructureDefinitionDerivationValidValues(): string[] {
    return StructureDefinitionDerivation_list_ValidValues;
  }
  
  /**
  * Gets the current value of field derivation.
  * @returns the value  or undefined
  */
  public getDerivation(): string | undefined {
      return this.derivation;
  }

  /**
  * Gets the current value of field derivation if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getDerivationOrElse(defaultValue: string): string {
      if (this.derivation == undefined || this.derivation == null ) { return defaultValue; }
      return this.derivation;
  }
