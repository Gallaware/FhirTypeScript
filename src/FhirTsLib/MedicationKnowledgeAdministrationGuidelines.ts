...
import { CodeableConcept, Extension, MedicationKnowledgeDosage, MedicationKnowledgePatientCharacteristics, Reference } from './index';
...
export class MedicationKnowledgeAdministrationGuidelines {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteDosageAll(): MedicationKnowledgeDosage[] {
    if (typeof(this.dosage) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteDosageBySplice(start: number, deleteCount?: number): MedicationKnowledgeDosage[] {
    if (typeof(this.dosage) !== 'undefined') {
  ...
  */
  ...
  /**
  * Removes all elements from the array patientCharacteristics, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deletePatientCharacteristicsAll(): MedicationKnowledgePatientCharacteristics[] {
    if (typeof(this.patientCharacteristics) !== 'undefined') {
       const oldArray = this.patientCharacteristics;
       delete this.patientCharacteristics;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array patientCharacteristics, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deletePatientCharacteristicsBySplice(start: number, deleteCount?: number): MedicationKnowledgePatientCharacteristics[] {
    if (typeof(this.patientCharacteristics) !== 'undefined') {
       return this.patientCharacteristics.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field patientCharacteristics.
  * @returns the value  or undefined
  */
