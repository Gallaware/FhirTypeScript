...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_ONSETDATETIME, REGEX_ONSETSTRING, REGEX_RECORDEDDATE, REGEX_LASTOCCURRENCE } from '../FhirTsLibValidation/FhirRegex';
import { Age, AllergyIntoleranceReaction, Annotation, CodeableConcept, Element, Extension, Identifier, Meta, Narrative, Period, Range, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './FhirType';
import { AllergyIntoleranceType_list_ValidValues, AllergyIntoleranceCriticality_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/AllergyIntolerance
 */
export class AllergyIntolerance {
   ...
   * Field access restricted because there are specific valid values.
   */
  protected lastOccurrence?: string;
  ...
  protected reaction?: AllergyIntoleranceReaction[];
  ...
  */
  public setType(newValue: string) {
    ...
    const idx = getValidValueIdx(AllergyIntoleranceType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.type = AllergyIntoleranceType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown type of " + newValue);
    }
  }
  
  public getAllergyIntoleranceTypeValidValues(): string[] {
  ...
  public addCategory(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  * that should be caught.
  */
  public setCriticality(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.criticality) !== 'undefined') {
         delete this.criticality;
      }
      return;
    }
    
    const idx = getValidValueIdx(AllergyIntoleranceCriticality_list_ValidValues, newValue);
    if (idx >= 0) {
      this.criticality = AllergyIntoleranceCriticality_list_ValidValues[idx];
    } else {
      throw new Error("Unknown criticality of " + newValue);
    }
  }
  
  public getAllergyIntoleranceCriticalityValidValues(): string[] {
  ...
  * that should be caught.
  */
  public setLastOccurrence(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.lastOccurrence) !== 'undefined') {
         delete this.lastOccurrence;
      }
      return;
    }
    
    if (REGEX_LASTOCCURRENCE.test(newValue)) {
      this.lastOccurrence = newValue
    } else {
      throw new Error("Invalid value pattern for lastOccurrence of " + newValue);
    }
  }
  
  public getLastOccurrencePattern(): string {
