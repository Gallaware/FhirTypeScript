 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/AuditEvent
 */
export class AuditEvent {
  ...
  protected purposeOfEvent?: CodeableConcept[];
  ...
  protected agent?: AuditEventAgent[];
  ...
  protected entity?: AuditEventEntity[];
  ...
  * that should be caught.
  */
  public setAction(newValue: string) {
    if (typeof(newValue) === 'undefined') {
    ...
    const idx = getValidValueIdx(AuditEventAction_list_ValidValues, newValue);
    if (idx >= 0) {
      this.action = AuditEventAction_list_ValidValues[idx];
    } else {
      throw new Error("Unknown action of " + newValue);
    }
  }
  
  public getAuditEventActionValidValues(): string[] {
  ...
  */
  public setOutcome(newValue: string) {
    ...
    const idx = getValidValueIdx(AuditEventOutcome_list_ValidValues, newValue);
    if (idx >= 0) {
      this.outcome = AuditEventOutcome_list_ValidValues[idx];
    } else {
      throw new Error("Unknown outcome of " + newValue);
    }
  }
  
  public getAuditEventOutcomeValidValues(): string[] {
  ...
  * that should be caught.
  */
  public setOutcomeDesc(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.outcomeDesc) !== 'undefined') {
         delete this.outcomeDesc;
      }
      return;
    }
    
    if (REGEX_OUTCOMEDESC.test(newValue)) {
      this.outcomeDesc = newValue
    } else {
      throw new Error("Invalid value pattern for outcomeDesc of " + newValue);
    }
  }
  
  public getOutcomeDescPattern(): string {
  ...
  public addPurposeOfEvent(newValue: CodeableConcept) {
    if (typeof(newValue) === 'undefined') {
