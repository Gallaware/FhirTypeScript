...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_CREATED_000 } from '../FhirTsLibValidation/FhirRegex';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Basic
 */
export class Basic {
  /**
  ...
  */
  public setCreated(newValue: string) {
    ...
    if (REGEX_CREATED_000.test(newValue)) {
  ...
  public getCreatedPattern(): string {
    return REGEX_CREATED_000.source;
  }
