...
import { REGEX_ID, REGEX_NAME, REGEX_VALUEBASE64BINARY, REGEX_VALUECANONICAL, REGEX_VALUECODE, REGEX_VALUEDATE, REGEX_VALUEDATETIME, REGEX_VALUEID, REGEX_VALUEINSTANT, REGEX_VALUEMARKDOWN, REGEX_VALUEOID, REGEX_VALUESTRING, REGEX_VALUETIME, REGEX_VALUEURI, REGEX_VALUEURL, REGEX_VALUEUUID } from '../FhirTsLibValidation/FhirRegex';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Parameters_Parameter
 */
export class ParametersParameter {
  ...
  protected part?: ParametersParameter[];
  ...
  */
  ...
  public addPart(newValue: ParametersParameter) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getPartOrElse(defaultValue: ParametersParameter[]): ParametersParameter[] {
