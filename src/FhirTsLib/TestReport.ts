...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_NAME, REGEX_TESTER, REGEX_ISSUED } from '../FhirTsLibValidation/FhirRegex';
import { Element, Extension, Identifier, Meta, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestScript, ValueSet, VerificationResult, VisionPrescription, TestReportParticipant, TestReportSetup, TestReportTeardown, TestReportTest } from './index';
import { TestReportStatus_list_ValidValues, TestReportResult_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestReport
 */
export class TestReport {
  ...
  protected participant?: TestReportParticipant[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(TestReportStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = TestReportStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getTestReportStatusValidValues(): string[] {
    return TestReportStatus_list_ValidValues;
  }
  ...
  */
  public setResult(newValue: string) {
    ...
    const idx = getValidValueIdx(TestReportResult_list_ValidValues, newValue);
    if (idx >= 0) {
      this.result = TestReportResult_list_ValidValues[idx];
    } else {
      throw new Error("Unknown result of " + newValue);
    }
  }
  
  public getTestReportResultValidValues(): string[] {
    return TestReportResult_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setTester(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.tester) !== 'undefined') {
         delete this.tester;
      }
      return;
    }
    
    if (REGEX_TESTER.test(newValue)) {
      this.tester = newValue
    } else {
      throw new Error("Invalid value pattern for tester of " + newValue);
    }
  }
  
  public getTesterPattern(): string {
    return REGEX_TESTER.source;
  }
  
  /**
  * Gets the current value of field tester.
  * @returns the value  or undefined
  */
  public getTester(): string | undefined {
      return this.tester;
  }

  /**
  * Gets the current value of field tester if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getTesterOrElse(defaultValue: string): string {
      if (this.tester == undefined || this.tester == null ) { return defaultValue; }
      return this.tester;
  }
  ...
  */
  ...
  public addParticipant(newValue: TestReportParticipant) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteParticipantAll(): TestReportParticipant[] {
    if (typeof(this.participant) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteParticipantBySplice(start: number, deleteCount?: number): TestReportParticipant[] {
    if (typeof(this.participant) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getParticipantOrElse(defaultValue: TestReportParticipant[]): TestReportParticipant[] {
      if (this.participant == undefined || this.participant == null ) { return defaultValue; }
      return this.participant;
  }

  public addTest(newValue: TestReportTest) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteTestAll(): TestReportTest[] {
    if (typeof(this.test) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteTestBySplice(start: number, deleteCount?: number): TestReportTest[] {
    if (typeof(this.test) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getTestOrElse(defaultValue: TestReportTest[]): TestReportTest[] {
