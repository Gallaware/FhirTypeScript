...
export class CareTeam {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteParticipantAll(): CareTeamParticipant[] {
    if (typeof(this.participant) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteParticipantBySplice(start: number, deleteCount?: number): CareTeamParticipant[] {
    if (typeof(this.participant) !== 'undefined') {
  ...
  */
  ...
  /**
  * Removes all elements from the array managingOrganization, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteManagingOrganizationAll(): Reference[] {
    if (typeof(this.managingOrganization) !== 'undefined') {
       const oldArray = this.managingOrganization;
       delete this.managingOrganization;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array managingOrganization, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteManagingOrganizationBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.managingOrganization) !== 'undefined') {
       return this.managingOrganization.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field managingOrganization.
  * @returns the value  or undefined
  */
