 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ClinicalImpression_Investigation
 */
export class ClinicalImpressionInvestigation {
  ...
  */
  ...
  public addItem(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteItemAll(): Reference[] {
    if (typeof(this.item) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteItemBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.item) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getItem(): Reference[] | undefined {
      return this.item;
  }
  ...
  * @returns the value or the parameter value
  */
  public getItemOrElse(defaultValue: Reference[]): Reference[] {
