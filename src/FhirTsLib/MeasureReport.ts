...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_MEASURE, REGEX_DATE } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, Element, Extension, Identifier, MeasureReportGroup, Meta, Narrative, Period, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './index';
import { MeasureReportStatus_list_ValidValues, MeasureReportType_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/MeasureReport
 */
export class MeasureReport {
   ...
   * members that meet the various criteria in the measure; a summary report, which returns a
   * population count for each of the criteria in the measure; or a data-collection, which enables the
  ...
  protected group?: MeasureReportGroup[];
   ...
   */
  @Type(() => Reference)
  protected evaluatedResource?: Reference[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(MeasureReportStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = MeasureReportStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getMeasureReportStatusValidValues(): string[] {
    return MeasureReportStatus_list_ValidValues;
  }
  ...
  */
  public setType(newValue: string) {
    ...
    const idx = getValidValueIdx(MeasureReportType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.type = MeasureReportType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown type of " + newValue);
    }
  }
  
  public getMeasureReportTypeValidValues(): string[] {
    return MeasureReportType_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setMeasure(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.measure) !== 'undefined') {
         delete this.measure;
      }
      return;
    }
    
    if (REGEX_MEASURE.test(newValue)) {
      this.measure = newValue
    } else {
      throw new Error("Invalid value pattern for measure of " + newValue);
    }
  }
  
  public getMeasurePattern(): string {
    return REGEX_MEASURE.source;
  }
  
  /**
  * Gets the current value of field measure.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field measure if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getMeasureOrElse(defaultValue: string): string {
      if (this.measure == undefined || this.measure == null ) { return defaultValue; }
      return this.measure;
  }
  ...
  */
  ...
  public addGroup(newValue: MeasureReportGroup) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteGroupAll(): MeasureReportGroup[] {
    if (typeof(this.group) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteGroupBySplice(start: number, deleteCount?: number): MeasureReportGroup[] {
    if (typeof(this.group) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getGroupOrElse(defaultValue: MeasureReportGroup[]): MeasureReportGroup[] {
      if (this.group == undefined || this.group == null ) { return defaultValue; }
      return this.group;
  }

  public addEvaluatedResource(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array evaluatedResource, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteEvaluatedResourceAll(): Reference[] {
    if (typeof(this.evaluatedResource) !== 'undefined') {
       const oldArray = this.evaluatedResource;
       delete this.evaluatedResource;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array evaluatedResource, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteEvaluatedResourceBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.evaluatedResource) !== 'undefined') {
       return this.evaluatedResource.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field evaluatedResource.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field evaluatedResource if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getEvaluatedResourceOrElse(defaultValue: Reference[]): Reference[] {
      if (this.evaluatedResource == undefined || this.evaluatedResource == null ) { return defaultValue; }
      return this.evaluatedResource;
  }
