...
import { REGEX_ID, REGEX_CODE, REGEX_DESCRIPTION, REGEX_VALUE } from '../FhirTsLibValidation/FhirRegex';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/CodeSystem_Filter
 */
export class CodeSystemFilter {
  ...
  */
  ...
  public addOperator(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  public add_operator(newValue: Element) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field _operator if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public get_operatorOrElse(defaultValue: Element[]): Element[] {
      if (this._operator == undefined || this._operator == null ) { return defaultValue; }
      return this._operator;
  }
