...
import { Element, Extension, TestReportAction1 } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestReport_Test
 */
export class TestReportTest {
  ...
  protected action?: TestReportAction1[];
  ...
  */
  ...
  public addAction(newValue: TestReportAction1) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteActionAll(): TestReportAction1[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteActionBySplice(start: number, deleteCount?: number): TestReportAction1[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getActionOrElse(defaultValue: TestReportAction1[]): TestReportAction1[] {
