...
import { Extension, TestReportAction } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestReport_Setup
 */
export class TestReportSetup {
  ...
  protected action?: TestReportAction[];
  ...
  */
  ...
  public addAction(newValue: TestReportAction) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteActionAll(): TestReportAction[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteActionBySplice(start: number, deleteCount?: number): TestReportAction[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getAction(): TestReportAction[] | undefined {
      return this.action;
  }
  ...
  * @returns the value or the parameter value
  */
  public getActionOrElse(defaultValue: TestReportAction[]): TestReportAction[] {
