...
export class TestScriptTest {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteActionAll(): TestScriptAction1[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteActionBySplice(start: number, deleteCount?: number): TestScriptAction1[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getActionOrElse(defaultValue: TestScriptAction1[]): TestScriptAction1[] {
