...
import { REGEX_ID, REGEX_NAME_000, REGEX_TYPE_000, REGEX_DOCUMENTATION } from '../FhirTsLibValidation/FhirRegex';
import { Element, Extension } from './FhirType';
import { StructureMapInputMode_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/StructureMap_Input
 */
export class StructureMapInput {
  /**
  ...
  */
  public setMode(newValue: string) {
    ...
    const idx = getValidValueIdx(StructureMapInputMode_list_ValidValues, newValue);
    if (idx >= 0) {
      this.mode = StructureMapInputMode_list_ValidValues[idx];
    } else {
      throw new Error("Unknown mode of " + newValue);
    }
  }
  
  public getStructureMapInputModeValidValues(): string[] {
    return StructureMapInputMode_list_ValidValues;
  }
