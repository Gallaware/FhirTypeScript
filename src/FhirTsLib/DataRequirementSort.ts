...
import { DataRequirementSortDirection_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/DataRequirement_Sort
 */
export class DataRequirementSort {
  ...
  */
  public setDirection(newValue: string) {
    ...
    const idx = getValidValueIdx(DataRequirementSortDirection_list_ValidValues, newValue);
    if (idx >= 0) {
      this.direction = DataRequirementSortDirection_list_ValidValues[idx];
    } else {
      throw new Error("Unknown direction of " + newValue);
    }
  }
  
  public getDataRequirementSortDirectionValidValues(): string[] {
    return DataRequirementSortDirection_list_ValidValues;
  }
