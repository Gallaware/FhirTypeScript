...
export class Annotation {
  ...
  */
  ...
  /**
  * Gets the current value of field authorString.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field authorString if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getAuthorStringOrElse(defaultValue: string): string {
      if (this.authorString == undefined || this.authorString == null ) { return defaultValue; }
      return this.authorString;
  }
