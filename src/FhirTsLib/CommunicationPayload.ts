 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Communication_Payload
 */
export class CommunicationPayload {
  ...
  */
  ...
  /**
  * Gets the current value of field contentString.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field contentString if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getContentStringOrElse(defaultValue: string): string {
      if (this.contentString == undefined || this.contentString == null ) { return defaultValue; }
      return this.contentString;
  }
