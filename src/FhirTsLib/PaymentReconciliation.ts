 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/PaymentReconciliation
 */
export class PaymentReconciliation {
  ...
  protected detail?: PaymentReconciliationDetail[];
  ...
  protected processNote?: PaymentReconciliationProcessNote[];
  ...
  */
  public setOutcome(newValue: string) {
    ...
    const idx = getValidValueIdx(PaymentReconciliationOutcome_list_ValidValues, newValue);
    if (idx >= 0) {
      this.outcome = PaymentReconciliationOutcome_list_ValidValues[idx];
    } else {
      throw new Error("Unknown outcome of " + newValue);
    }
  }
  
  public getPaymentReconciliationOutcomeValidValues(): string[] {
    return PaymentReconciliationOutcome_list_ValidValues;
  }
  ...
  */
  public setPaymentDate(newValue: string) {
    ...
    if (REGEX_PAYMENTDATE_000.test(newValue)) {
  ...
  public getPaymentDatePattern(): string {
    return REGEX_PAYMENTDATE_000.source;
  }
  ...
  */
  ...
  public addDetail(newValue: PaymentReconciliationDetail) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteDetailAll(): PaymentReconciliationDetail[] {
    if (typeof(this.detail) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteDetailBySplice(start: number, deleteCount?: number): PaymentReconciliationDetail[] {
    if (typeof(this.detail) !== 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteProcessNoteAll(): PaymentReconciliationProcessNote[] {
    if (typeof(this.processNote) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteProcessNoteBySplice(start: number, deleteCount?: number): PaymentReconciliationProcessNote[] {
    if (typeof(this.processNote) !== 'undefined') {
