...
export class Money {
  ...
  */
  ...
  /**
  * Gets the current value of field currency.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field currency if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getCurrencyOrElse(defaultValue: string): string {
      if (this.currency == undefined || this.currency == null ) { return defaultValue; }
      return this.currency;
  }
