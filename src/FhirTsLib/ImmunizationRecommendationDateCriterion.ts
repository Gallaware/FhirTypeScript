...
import { REGEX_ID, REGEX_VALUE_000 } from '../FhirTsLibValidation/FhirRegex';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ImmunizationRecommendation_DateCriterion
 */
export class ImmunizationRecommendationDateCriterion {
  /**
  ...
  */
  public setValue(newValue: string) {
    ...
    if (REGEX_VALUE_000.test(newValue)) {
      this.value = newValue
    } else {
