...
import { Address, ClaimResponseAdjudication, ClaimResponseDetail1, CodeableConcept, Element, Extension, Money, Period, Quantity, Reference } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ClaimResponse_AddItem
 */
export class ClaimResponseAddItem {
  ...
  /**
   * The sequence number of the sub-details within the details within the claim item which this line is
   * intended to replace.
   * Field access restricted because there are specific valid values.
   */
  ...
  protected detail?: ClaimResponseDetail1[];
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteDetailAll(): ClaimResponseDetail1[] {
    if (typeof(this.detail) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteDetailBySplice(start: number, deleteCount?: number): ClaimResponseDetail1[] {
    if (typeof(this.detail) !== 'undefined') {
