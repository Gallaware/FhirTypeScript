...
import { Extension, TestScriptAction2 } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestScript_Teardown
 */
export class TestScriptTeardown {
  ...
  protected action?: TestScriptAction2[];
  ...
  */
  ...
  public addAction(newValue: TestScriptAction2) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteActionAll(): TestScriptAction2[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteActionBySplice(start: number, deleteCount?: number): TestScriptAction2[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getAction(): TestScriptAction2[] | undefined {
      return this.action;
  }
  ...
  * @returns the value or the parameter value
  */
  public getActionOrElse(defaultValue: TestScriptAction2[]): TestScriptAction2[] {
