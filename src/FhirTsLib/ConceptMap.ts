 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ConceptMap
 */
export class ConceptMap {
   ...
   * Field access restricted because there are specific valid values.
   */
  protected sourceCanonical?: string;
   ...
   * Field access restricted because there are specific valid values.
   */
  protected targetCanonical?: string;
  ...
  protected group?: ConceptMapGroup[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(ConceptMapStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = ConceptMapStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getConceptMapStatusValidValues(): string[] {
    return ConceptMapStatus_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setSourceUri(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.sourceUri) !== 'undefined') {
         delete this.sourceUri;
      }
      return;
    }
    
    if (REGEX_SOURCEURI.test(newValue)) {
      this.sourceUri = newValue
    } else {
      throw new Error("Invalid value pattern for sourceUri of " + newValue);
    }
  }
  
  public getSourceUriPattern(): string {
    return REGEX_SOURCEURI.source;
  }
  
  /**
  * Gets the current value of field sourceUri.
  * @returns the value  or undefined
  */
  ...
  * that should be caught.
  */
  public setSourceCanonical(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.sourceCanonical) !== 'undefined') {
         delete this.sourceCanonical;
      }
      return;
    }
    
    if (REGEX_SOURCECANONICAL.test(newValue)) {
      this.sourceCanonical = newValue
    } else {
      throw new Error("Invalid value pattern for sourceCanonical of " + newValue);
    }
  }
  
  public getSourceCanonicalPattern(): string {
    return REGEX_SOURCECANONICAL.source;
  }
  
  /**
  * Gets the current value of field sourceCanonical.
  * @returns the value  or undefined
  */
  public getSourceCanonical(): string | undefined {
  ...
  * that should be caught.
  */
  public setTargetUri(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.targetUri) !== 'undefined') {
         delete this.targetUri;
      }
      return;
    }
    
    if (REGEX_TARGETURI.test(newValue)) {
      this.targetUri = newValue
    } else {
      throw new Error("Invalid value pattern for targetUri of " + newValue);
    }
  }
  
  public getTargetUriPattern(): string {
    return REGEX_TARGETURI.source;
  }
  
  /**
  * Gets the current value of field targetUri.
  * @returns the value  or undefined
  */
  ...
  * that should be caught.
  */
  public setTargetCanonical(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.targetCanonical) !== 'undefined') {
         delete this.targetCanonical;
      }
      return;
    }
    
    if (REGEX_TARGETCANONICAL.test(newValue)) {
      this.targetCanonical = newValue
    } else {
      throw new Error("Invalid value pattern for targetCanonical of " + newValue);
    }
  }
  
  public getTargetCanonicalPattern(): string {
    return REGEX_TARGETCANONICAL.source;
  }
  
  /**
  * Gets the current value of field targetCanonical.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  public addGroup(newValue: ConceptMapGroup) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteGroupAll(): ConceptMapGroup[] {
    if (typeof(this.group) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteGroupBySplice(start: number, deleteCount?: number): ConceptMapGroup[] {
    if (typeof(this.group) !== 'undefined') {
