...
export class Media {
  ...
  */
  ...
  /**
  * Gets the current value of field createdDateTime.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field createdDateTime if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getCreatedDateTimeOrElse(defaultValue: string): string {
      if (this.createdDateTime == undefined || this.createdDateTime == null ) { return defaultValue; }
      return this.createdDateTime;
  }
  ...
  * @returns the value or the parameter value
  */
  public getDeviceNameOrElse(defaultValue: string): string {
