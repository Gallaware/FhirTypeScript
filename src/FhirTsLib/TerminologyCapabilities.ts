...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_URL, REGEX_VERSION, REGEX_NAME, REGEX_TITLE, REGEX_DATE, REGEX_PUBLISHER, REGEX_DESCRIPTION, REGEX_PURPOSE, REGEX_COPYRIGHT, REGEX_KIND } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, ContactDetail, Element, Extension, Meta, Narrative, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, TerminologyCapabilitiesClosure, TerminologyCapabilitiesCodeSystem, TerminologyCapabilitiesExpansion, TerminologyCapabilitiesImplementation, TerminologyCapabilitiesSoftware, TerminologyCapabilitiesTranslation, TerminologyCapabilitiesValidateCode, UsageContext } from './index';
import { TerminologyCapabilitiesStatus_list_ValidValues, TerminologyCapabilitiesCodeSearch_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TerminologyCapabilities
 */
export class TerminologyCapabilities {
  ...
  protected codeSystem?: TerminologyCapabilitiesCodeSystem[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(TerminologyCapabilitiesStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = TerminologyCapabilitiesStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getTerminologyCapabilitiesStatusValidValues(): string[] {
  ...
  */
  ...
  public addCodeSystem(newValue: TerminologyCapabilitiesCodeSystem) {
    if (typeof(newValue) === 'undefined') {
  ...
  */
  ...
  /**
  * Gets the current value of field codeSystem if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getCodeSystemOrElse(defaultValue: TerminologyCapabilitiesCodeSystem[]): TerminologyCapabilitiesCodeSystem[] {
      if (this.codeSystem == undefined || this.codeSystem == null ) { return defaultValue; }
      return this.codeSystem;
  }
  ...
  * that should be caught.
  */
  public setCodeSearch(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.codeSearch) !== 'undefined') {
         delete this.codeSearch;
      }
      return;
    }
    
    const idx = getValidValueIdx(TerminologyCapabilitiesCodeSearch_list_ValidValues, newValue);
    if (idx >= 0) {
      this.codeSearch = TerminologyCapabilitiesCodeSearch_list_ValidValues[idx];
    } else {
      throw new Error("Unknown codeSearch of " + newValue);
    }
  }
  
  public getTerminologyCapabilitiesCodeSearchValidValues(): string[] {
  ...
  */
  ...
  /**
  * Gets the current value of field codeSearch if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getCodeSearchOrElse(defaultValue: string): string {
      if (this.codeSearch == undefined || this.codeSearch == null ) { return defaultValue; }
      return this.codeSearch;
  }
