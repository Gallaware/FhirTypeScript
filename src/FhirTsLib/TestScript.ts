...
import { CodeableConcept, ContactDetail, Element, Extension, Identifier, Meta, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, ValueSet, VerificationResult, VisionPrescription, TestScriptDestination, TestScriptFixture, TestScriptMetadata, TestScriptOrigin, TestScriptSetup, TestScriptTeardown, TestScriptTest, TestScriptVariable, UsageContext } from './index';
import { TestScriptStatus_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestScript
 */
export class TestScript {
  ...
  protected origin?: TestScriptOrigin[];
  ...
  protected destination?: TestScriptDestination[];
  ...
  protected fixture?: TestScriptFixture[];
  ...
  protected variable?: TestScriptVariable[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(TestScriptStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = TestScriptStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getTestScriptStatusValidValues(): string[] {
    return TestScriptStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addOrigin(newValue: TestScriptOrigin) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteOriginAll(): TestScriptOrigin[] {
    if (typeof(this.origin) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteOriginBySplice(start: number, deleteCount?: number): TestScriptOrigin[] {
    if (typeof(this.origin) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getOriginOrElse(defaultValue: TestScriptOrigin[]): TestScriptOrigin[] {
      if (this.origin == undefined || this.origin == null ) { return defaultValue; }
      return this.origin;
  }

  public addDestination(newValue: TestScriptDestination) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteDestinationAll(): TestScriptDestination[] {
    if (typeof(this.destination) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteDestinationBySplice(start: number, deleteCount?: number): TestScriptDestination[] {
    if (typeof(this.destination) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getDestinationOrElse(defaultValue: TestScriptDestination[]): TestScriptDestination[] {
      if (this.destination == undefined || this.destination == null ) { return defaultValue; }
      return this.destination;
  }

  public addFixture(newValue: TestScriptFixture) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array fixture, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteFixtureAll(): TestScriptFixture[] {
    if (typeof(this.fixture) !== 'undefined') {
       const oldArray = this.fixture;
       delete this.fixture;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array fixture, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteFixtureBySplice(start: number, deleteCount?: number): TestScriptFixture[] {
    if (typeof(this.fixture) !== 'undefined') {
       return this.fixture.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field fixture.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field fixture if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getFixtureOrElse(defaultValue: TestScriptFixture[]): TestScriptFixture[] {
      if (this.fixture == undefined || this.fixture == null ) { return defaultValue; }
      return this.fixture;
  }

  public addProfile(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteProfileAll(): Reference[] {
    if (typeof(this.profile) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteProfileBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.profile) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getProfileOrElse(defaultValue: Reference[]): Reference[] {
      if (this.profile == undefined || this.profile == null ) { return defaultValue; }
      return this.profile;
  }

  public addVariable(newValue: TestScriptVariable) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array variable, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteVariableAll(): TestScriptVariable[] {
    if (typeof(this.variable) !== 'undefined') {
       const oldArray = this.variable;
       delete this.variable;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array variable, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteVariableBySplice(start: number, deleteCount?: number): TestScriptVariable[] {
    if (typeof(this.variable) !== 'undefined') {
       return this.variable.splice(start, deleteCount);
    }
    return [];
  }
  ...
  * @returns the value or the parameter value
  */
  public getVariableOrElse(defaultValue: TestScriptVariable[]): TestScriptVariable[] {
      if (this.variable == undefined || this.variable == null ) { return defaultValue; }
      return this.variable;
  }

  public addTest(newValue: TestScriptTest) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array test, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteTestAll(): TestScriptTest[] {
    if (typeof(this.test) !== 'undefined') {
       const oldArray = this.test;
       delete this.test;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array test, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteTestBySplice(start: number, deleteCount?: number): TestScriptTest[] {
    if (typeof(this.test) !== 'undefined') {
       return this.test.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field test.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field test if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getTestOrElse(defaultValue: TestScriptTest[]): TestScriptTest[] {
      if (this.test == undefined || this.test == null ) { return defaultValue; }
      return this.test;
  }
