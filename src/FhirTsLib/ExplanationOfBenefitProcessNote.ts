...
import { ExplanationOfBenefitProcessNoteType_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ExplanationOfBenefit_ProcessNote
 */
export class ExplanationOfBenefitProcessNote {
  ...
  */
  public setType(newValue: string) {
    ...
    const idx = getValidValueIdx(ExplanationOfBenefitProcessNoteType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.type = ExplanationOfBenefitProcessNoteType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown type of " + newValue);
    }
  }
  
  public getExplanationOfBenefitProcessNoteTypeValidValues(): string[] {
    return ExplanationOfBenefitProcessNoteType_list_ValidValues;
  }
