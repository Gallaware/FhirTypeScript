...
import { REGEX_ID, REGEX_SOURCE_000, REGEX_SOURCEID } from '../FhirTsLibValidation/FhirRegex';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/OperationDefinition_ReferencedFrom
 */
export class OperationDefinitionReferencedFrom {
  /**
  ...
  */
  public setSourceId(newValue: string) {
    ...
    if (REGEX_SOURCEID.test(newValue)) {
