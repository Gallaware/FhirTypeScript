 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Organization
 */
export class Organization {
  ...
  protected contact?: OrganizationContact[];
  ...
  */
  ...
  public addContact(newValue: OrganizationContact) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteContactAll(): OrganizationContact[] {
    if (typeof(this.contact) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteContactBySplice(start: number, deleteCount?: number): OrganizationContact[] {
    if (typeof(this.contact) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getContact(): OrganizationContact[] | undefined {
      return this.contact;
  }
  ...
  * @returns the value or the parameter value
  */
  public getContactOrElse(defaultValue: OrganizationContact[]): OrganizationContact[] {
