...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_URL, REGEX_VERSION, REGEX_NAME, REGEX_TITLE, REGEX_SHORTTITLE, REGEX_SUBTITLE, REGEX_DATE, REGEX_PUBLISHER, REGEX_DESCRIPTION, REGEX_PURPOSE, REGEX_USAGE, REGEX_COPYRIGHT, REGEX_APPROVALDATE, REGEX_LASTREVIEWDATE } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, ContactDetail, Element, Extension, Identifier, Meta, Narrative, Period, Reference, RelatedArtifact, ResearchElementDefinitionCharacteristic, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, UsageContext } from './index';
import { ResearchElementDefinitionStatus_list_ValidValues, ResearchElementDefinitionType_list_ValidValues, ResearchElementDefinitionVariableType_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ResearchElementDefinition
 */
export class ResearchElementDefinition {
  ...
  protected characteristic?: ResearchElementDefinitionCharacteristic[];
  ...
  */
  ...
  /**
  * Gets the current value of field shortTitle.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field shortTitle if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getShortTitleOrElse(defaultValue: string): string {
      if (this.shortTitle == undefined || this.shortTitle == null ) { return defaultValue; }
      return this.shortTitle;
  }
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(ResearchElementDefinitionStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = ResearchElementDefinitionStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getResearchElementDefinitionStatusValidValues(): string[] {
    return ResearchElementDefinitionStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addComment(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array comment, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteCommentAll(): string[] {
    if (typeof(this.comment) !== 'undefined') {
       const oldArray = this.comment;
       delete this.comment;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array comment, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteCommentBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.comment) !== 'undefined') {
       return this.comment.splice(start, deleteCount);
    }
    return [];
  }
  ...
  */
  ...
  public add_comment(newValue: Element) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array _comment, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public delete_commentAll(): Element[] {
    if (typeof(this._comment) !== 'undefined') {
       const oldArray = this._comment;
       delete this._comment;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array _comment, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public delete_commentBySplice(start: number, deleteCount?: number): Element[] {
    if (typeof(this._comment) !== 'undefined') {
       return this._comment.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field _comment.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field _comment if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public get_commentOrElse(defaultValue: Element[]): Element[] {
      if (this._comment == undefined || this._comment == null ) { return defaultValue; }
      return this._comment;
  }
  ...
  */
  public setType(newValue: string) {
    ...
    const idx = getValidValueIdx(ResearchElementDefinitionType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.type = ResearchElementDefinitionType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown type of " + newValue);
    }
  }
  
  public getResearchElementDefinitionTypeValidValues(): string[] {
    return ResearchElementDefinitionType_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setVariableType(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.variableType) !== 'undefined') {
         delete this.variableType;
      }
      return;
    }
    
    const idx = getValidValueIdx(ResearchElementDefinitionVariableType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.variableType = ResearchElementDefinitionVariableType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown variableType of " + newValue);
    }
  }
  
  public getResearchElementDefinitionVariableTypeValidValues(): string[] {
    return ResearchElementDefinitionVariableType_list_ValidValues;
  }
  
  /**
  * Gets the current value of field variableType.
  * @returns the value  or undefined
  */
  public getVariableType(): string | undefined {
      return this.variableType;
  }

  /**
  * Gets the current value of field variableType if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getVariableTypeOrElse(defaultValue: string): string {
      if (this.variableType == undefined || this.variableType == null ) { return defaultValue; }
      return this.variableType;
  }

  public addCharacteristic(newValue: ResearchElementDefinitionCharacteristic) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteCharacteristicAll(): ResearchElementDefinitionCharacteristic[] {
    if (typeof(this.characteristic) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteCharacteristicBySplice(start: number, deleteCount?: number): ResearchElementDefinitionCharacteristic[] {
    if (typeof(this.characteristic) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getCharacteristicOrElse(defaultValue: ResearchElementDefinitionCharacteristic[]): ResearchElementDefinitionCharacteristic[] {
