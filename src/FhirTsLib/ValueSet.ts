 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ValueSet
 */
export class ValueSet {
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(ValueSetStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = ValueSetStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getValueSetStatusValidValues(): string[] {
    return ValueSetStatus_list_ValidValues;
  }
