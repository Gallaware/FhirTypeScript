...
export class GoalTarget {
  ...
  */
  ...
  /**
  * Gets the current value of field detailString if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getDetailStringOrElse(defaultValue: string): string {
      if (this.detailString == undefined || this.detailString == null ) { return defaultValue; }
      return this.detailString;
  }
  ...
  */
  ...
  /**
  * Gets the current value of field dueDate if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getDueDateOrElse(defaultValue: string): string {
      if (this.dueDate == undefined || this.dueDate == null ) { return defaultValue; }
      return this.dueDate;
  }
