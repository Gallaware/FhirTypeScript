...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_URL, REGEX_VERSION, REGEX_NAME, REGEX_TITLE, REGEX_DATE, REGEX_PUBLISHER, REGEX_DESCRIPTION, REGEX_PURPOSE, REGEX_COPYRIGHT, REGEX_VALUESET, REGEX_SUPPLEMENTS } from '../FhirTsLibValidation/FhirRegex';
import { CodeSystemConcept, CodeSystemFilter, CodeSystemProperty, CodeableConcept, ContactDetail, Element, Extension, Identifier, Meta, Narrative, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, UsageContext } from './index';
import { CodeSystemStatus_list_ValidValues, CodeSystemHierarchyMeaning_list_ValidValues, CodeSystemContent_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/CodeSystem
 */
export class CodeSystem {
   ...
   * Field access restricted because there are specific valid values.
   */
  protected hierarchyMeaning?: string;
  ...
  protected filter?: CodeSystemFilter[];
  ...
  protected property?: CodeSystemProperty[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(CodeSystemStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = CodeSystemStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getCodeSystemStatusValidValues(): string[] {
    return CodeSystemStatus_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setHierarchyMeaning(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.hierarchyMeaning) !== 'undefined') {
         delete this.hierarchyMeaning;
      }
      return;
    }
    
    const idx = getValidValueIdx(CodeSystemHierarchyMeaning_list_ValidValues, newValue);
    if (idx >= 0) {
      this.hierarchyMeaning = CodeSystemHierarchyMeaning_list_ValidValues[idx];
    } else {
      throw new Error("Unknown hierarchyMeaning of " + newValue);
    }
  }
  
  public getCodeSystemHierarchyMeaningValidValues(): string[] {
    return CodeSystemHierarchyMeaning_list_ValidValues;
  }
  
  /**
  * Gets the current value of field hierarchyMeaning.
  * @returns the value  or undefined
  */
  public getHierarchyMeaning(): string | undefined {
      return this.hierarchyMeaning;
  }

  /**
  * Gets the current value of field hierarchyMeaning if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getHierarchyMeaningOrElse(defaultValue: string): string {
      if (this.hierarchyMeaning == undefined || this.hierarchyMeaning == null ) { return defaultValue; }
      return this.hierarchyMeaning;
  }
  ...
  */
  public setContent(newValue: string) {
    ...
    const idx = getValidValueIdx(CodeSystemContent_list_ValidValues, newValue);
    if (idx >= 0) {
      this.content = CodeSystemContent_list_ValidValues[idx];
    } else {
      throw new Error("Unknown content of " + newValue);
    }
  }
  
  public getCodeSystemContentValidValues(): string[] {
    return CodeSystemContent_list_ValidValues;
  }
  ...
  * @returns the value or the parameter value
  */
  public getContentOrElse(defaultValue: string): string {
  ...
  * that should be caught.
  */
  public setSupplements(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.supplements) !== 'undefined') {
         delete this.supplements;
      }
      return;
    }
    
    if (REGEX_SUPPLEMENTS.test(newValue)) {
      this.supplements = newValue
    } else {
      throw new Error("Invalid value pattern for supplements of " + newValue);
    }
  }
  
  public getSupplementsPattern(): string {
    return REGEX_SUPPLEMENTS.source;
  }
  
  /**
  * Gets the current value of field supplements.
  * @returns the value  or undefined
  */
  public getSupplements(): string | undefined {
      return this.supplements;
  }

  /**
  * Gets the current value of field supplements if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getSupplementsOrElse(defaultValue: string): string {
      if (this.supplements == undefined || this.supplements == null ) { return defaultValue; }
      return this.supplements;
  }

  public addFilter(newValue: CodeSystemFilter) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteFilterAll(): CodeSystemFilter[] {
    if (typeof(this.filter) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteFilterBySplice(start: number, deleteCount?: number): CodeSystemFilter[] {
    if (typeof(this.filter) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getFilterOrElse(defaultValue: CodeSystemFilter[]): CodeSystemFilter[] {
      if (this.filter == undefined || this.filter == null ) { return defaultValue; }
      return this.filter;
  }

  public addProperty(newValue: CodeSystemProperty) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deletePropertyAll(): CodeSystemProperty[] {
    if (typeof(this.property) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deletePropertyBySplice(start: number, deleteCount?: number): CodeSystemProperty[] {
    if (typeof(this.property) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getPropertyOrElse(defaultValue: CodeSystemProperty[]): CodeSystemProperty[] {
