 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ResearchSubject
 */
export class ResearchSubject {
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(ResearchSubjectStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = ResearchSubjectStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getResearchSubjectStatusValidValues(): string[] {
    return ResearchSubjectStatus_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setAssignedArm(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.assignedArm) !== 'undefined') {
         delete this.assignedArm;
      }
      return;
    }
    
    if (REGEX_ASSIGNEDARM.test(newValue)) {
      this.assignedArm = newValue
    } else {
      throw new Error("Invalid value pattern for assignedArm of " + newValue);
    }
  }
  
  public getAssignedArmPattern(): string {
    return REGEX_ASSIGNEDARM.source;
  }
  
  /**
  * Gets the current value of field assignedArm.
  * @returns the value  or undefined
  */
  public getAssignedArm(): string | undefined {
      return this.assignedArm;
  }

  /**
  * Gets the current value of field assignedArm if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getAssignedArmOrElse(defaultValue: string): string {
      if (this.assignedArm == undefined || this.assignedArm == null ) { return defaultValue; }
      return this.assignedArm;
  }
  ...
  * that should be caught.
  */
  public setActualArm(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.actualArm) !== 'undefined') {
         delete this.actualArm;
      }
      return;
    }
    
    if (REGEX_ACTUALARM.test(newValue)) {
      this.actualArm = newValue
    } else {
      throw new Error("Invalid value pattern for actualArm of " + newValue);
    }
  }
  
  public getActualArmPattern(): string {
    return REGEX_ACTUALARM.source;
  }
  
  /**
  * Gets the current value of field actualArm.
  * @returns the value  or undefined
  */
  public getActualArm(): string | undefined {
      return this.actualArm;
  }

  /**
  * Gets the current value of field actualArm if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getActualArmOrElse(defaultValue: string): string {
      if (this.actualArm == undefined || this.actualArm == null ) { return defaultValue; }
      return this.actualArm;
  }
