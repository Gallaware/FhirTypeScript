 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/MolecularSequence
 */
export class MolecularSequence {
  ...
  protected variant?: MolecularSequenceVariant[];

  /**
   * A sequence of Unicode characters
   * Field access restricted because there are specific valid values.
   */
  protected observedSeq?: string;
  ...
  protected quality?: MolecularSequenceQuality[];
  ...
  protected repository?: MolecularSequenceRepository[];
  ...
  protected structureVariant?: MolecularSequenceStructureVariant[];
  ...
  */
  public setType(newValue: string) {
    ...
    const idx = getValidValueIdx(MolecularSequenceType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.type = MolecularSequenceType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown type of " + newValue);
    }
  }
  
  public getMolecularSequenceTypeValidValues(): string[] {
  ...
  public addVariant(newValue: MolecularSequenceVariant) {
    if (typeof(newValue) === 'undefined') {
  ...
  * that should be caught.
  */
  public setObservedSeq(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.observedSeq) !== 'undefined') {
         delete this.observedSeq;
      }
      return;
    }
    
    if (REGEX_OBSERVEDSEQ.test(newValue)) {
      this.observedSeq = newValue
    } else {
      throw new Error("Invalid value pattern for observedSeq of " + newValue);
    }
  }
  
  public getObservedSeqPattern(): string {
  ...
  public addQuality(newValue: MolecularSequenceQuality) {
    if (typeof(newValue) === 'undefined') {
  ...
  public addPointer(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
