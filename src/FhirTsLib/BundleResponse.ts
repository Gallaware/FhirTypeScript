...
export class BundleResponse {
  ...
  */
  ...
  /**
  * Gets the current value of field etag.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field etag if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getEtagOrElse(defaultValue: string): string {
      if (this.etag == undefined || this.etag == null ) { return defaultValue; }
      return this.etag;
  }
