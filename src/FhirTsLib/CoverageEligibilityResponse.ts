 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/CoverageEligibilityResponse
 */
export class CoverageEligibilityResponse {
  ...
  protected insurance?: CoverageEligibilityResponseInsurance[];
  ...
  protected error?: CoverageEligibilityResponseError[];
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deletePurposeAll(): string[] {
    if (typeof(this.purpose) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deletePurposeBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.purpose) !== 'undefined') {
  ...
  */
  ...
  /**
  * Removes all elements from the array _purpose, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public delete_purposeAll(): Element[] {
    if (typeof(this._purpose) !== 'undefined') {
       const oldArray = this._purpose;
       delete this._purpose;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array _purpose, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public delete_purposeBySplice(start: number, deleteCount?: number): Element[] {
    if (typeof(this._purpose) !== 'undefined') {
       return this._purpose.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field _purpose.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field _purpose if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public get_purposeOrElse(defaultValue: Element[]): Element[] {
      if (this._purpose == undefined || this._purpose == null ) { return defaultValue; }
      return this._purpose;
  }
  ...
  */
  public setOutcome(newValue: string) {
    ...
    const idx = getValidValueIdx(CoverageEligibilityResponseOutcome_list_ValidValues, newValue);
    if (idx >= 0) {
      this.outcome = CoverageEligibilityResponseOutcome_list_ValidValues[idx];
    } else {
      throw new Error("Unknown outcome of " + newValue);
    }
  }
  
  public getCoverageEligibilityResponseOutcomeValidValues(): string[] {
    return CoverageEligibilityResponseOutcome_list_ValidValues;
  }
  ...
  */
  ...
  public addInsurance(newValue: CoverageEligibilityResponseInsurance) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteInsuranceAll(): CoverageEligibilityResponseInsurance[] {
    if (typeof(this.insurance) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteInsuranceBySplice(start: number, deleteCount?: number): CoverageEligibilityResponseInsurance[] {
    if (typeof(this.insurance) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getInsuranceOrElse(defaultValue: CoverageEligibilityResponseInsurance[]): CoverageEligibilityResponseInsurance[] {
  ...
  */
  ...
  public addError(newValue: CoverageEligibilityResponseError) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteErrorAll(): CoverageEligibilityResponseError[] {
    if (typeof(this.error) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteErrorBySplice(start: number, deleteCount?: number): CoverageEligibilityResponseError[] {
    if (typeof(this.error) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getErrorOrElse(defaultValue: CoverageEligibilityResponseError[]): CoverageEligibilityResponseError[] {
