 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/AppointmentResponse
 */
export class AppointmentResponse {
   ...
   * business processes and/ or used to refer to it when a direct URL reference to the resource itself
   * is not appropriate.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Identifier)
  ...
  protected participantType?: CodeableConcept[];
  ...
  */
  ...
  public addParticipantType(newValue: CodeableConcept) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array participantType, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteParticipantTypeAll(): CodeableConcept[] {
    if (typeof(this.participantType) !== 'undefined') {
       const oldArray = this.participantType;
       delete this.participantType;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array participantType, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteParticipantTypeBySplice(start: number, deleteCount?: number): CodeableConcept[] {
    if (typeof(this.participantType) !== 'undefined') {
       return this.participantType.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field participantType.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field participantType if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getParticipantTypeOrElse(defaultValue: CodeableConcept[]): CodeableConcept[] {
      if (this.participantType == undefined || this.participantType == null ) { return defaultValue; }
      return this.participantType;
  }
  ...
  * that should be caught.
  */
  public setParticipantStatus(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.participantStatus) !== 'undefined') {
         delete this.participantStatus;
      }
      return;
    }
    
    if (REGEX_PARTICIPANTSTATUS.test(newValue)) {
      this.participantStatus = newValue
    } else {
      throw new Error("Invalid value pattern for participantStatus of " + newValue);
    }
  }
  
  public getParticipantStatusPattern(): string {
    return REGEX_PARTICIPANTSTATUS.source;
  }
  
  /**
  * Gets the current value of field participantStatus.
  * @returns the value  or undefined
  */
  public getParticipantStatus(): string | undefined {
      return this.participantStatus;
  }

  /**
  * Gets the current value of field participantStatus if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getParticipantStatusOrElse(defaultValue: string): string {
      if (this.participantStatus == undefined || this.participantStatus == null ) { return defaultValue; }
      return this.participantStatus;
  }
