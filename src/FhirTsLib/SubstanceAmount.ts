...
import { CodeableConcept, Element, Extension, Quantity, Range, SubstanceAmountReferenceRange } from './index';
...
export class SubstanceAmount {
  ...
  */
  ...
  /**
  * Gets the current value of field amountText.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field amountText if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getAmountTextOrElse(defaultValue: string): string {
      if (this.amountText == undefined || this.amountText == null ) { return defaultValue; }
      return this.amountText;
  }
