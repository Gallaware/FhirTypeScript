...
import { CodeableConcept, Extension, Identifier, Quantity } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ProductShelfLife
 */
export class ProductShelfLife {
   ...
   */
  @Type(() => CodeableConcept)
  protected specialPrecautionsForStorage?: CodeableConcept[];
  ...
  public addSpecialPrecautionsForStorage(newValue: CodeableConcept) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.specialPrecautionsForStorage) !== 'undefined') {
         delete this.specialPrecautionsForStorage;
      }
      return;
    }
    ...
    this.specialPrecautionsForStorage.push(newValue);
  }
  /**
  * Removes all elements from the array specialPrecautionsForStorage, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteSpecialPrecautionsForStorageAll(): CodeableConcept[] {
    if (typeof(this.specialPrecautionsForStorage) !== 'undefined') {
       const oldArray = this.specialPrecautionsForStorage;
       delete this.specialPrecautionsForStorage;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array specialPrecautionsForStorage, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteSpecialPrecautionsForStorageBySplice(start: number, deleteCount?: number): CodeableConcept[] {
    if (typeof(this.specialPrecautionsForStorage) !== 'undefined') {
       return this.specialPrecautionsForStorage.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field specialPrecautionsForStorage.
  * @returns the value  or undefined
  */
