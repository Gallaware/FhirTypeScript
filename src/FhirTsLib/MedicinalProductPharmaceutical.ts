 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/MedicinalProductPharmaceutical
 */
export class MedicinalProductPharmaceutical {
   ...
   */
  @Type(() => Reference)
  protected ingredient?: Reference[];
  ...
  protected characteristics?: MedicinalProductPharmaceuticalCharacteristics[];
  ...
  protected routeOfAdministration?: MedicinalProductPharmaceuticalRouteOfAdministration[];
  ...
  */
  ...
  public addIngredient(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteIngredientAll(): Reference[] {
    if (typeof(this.ingredient) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteIngredientBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.ingredient) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getIngredientOrElse(defaultValue: Reference[]): Reference[] {
  ...
  */
  ...
  public addCharacteristics(newValue: MedicinalProductPharmaceuticalCharacteristics) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array characteristics, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteCharacteristicsAll(): MedicinalProductPharmaceuticalCharacteristics[] {
    if (typeof(this.characteristics) !== 'undefined') {
       const oldArray = this.characteristics;
       delete this.characteristics;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array characteristics, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteCharacteristicsBySplice(start: number, deleteCount?: number): MedicinalProductPharmaceuticalCharacteristics[] {
    if (typeof(this.characteristics) !== 'undefined') {
       return this.characteristics.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field characteristics.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field characteristics if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getCharacteristicsOrElse(defaultValue: MedicinalProductPharmaceuticalCharacteristics[]): MedicinalProductPharmaceuticalCharacteristics[] {
      if (this.characteristics == undefined || this.characteristics == null ) { return defaultValue; }
      return this.characteristics;
  }

  public addRouteOfAdministration(newValue: MedicinalProductPharmaceuticalRouteOfAdministration) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array routeOfAdministration, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteRouteOfAdministrationAll(): MedicinalProductPharmaceuticalRouteOfAdministration[] {
    if (typeof(this.routeOfAdministration) !== 'undefined') {
       const oldArray = this.routeOfAdministration;
       delete this.routeOfAdministration;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array routeOfAdministration, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteRouteOfAdministrationBySplice(start: number, deleteCount?: number): MedicinalProductPharmaceuticalRouteOfAdministration[] {
    if (typeof(this.routeOfAdministration) !== 'undefined') {
       return this.routeOfAdministration.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field routeOfAdministration.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field routeOfAdministration if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getRouteOfAdministrationOrElse(defaultValue: MedicinalProductPharmaceuticalRouteOfAdministration[]): MedicinalProductPharmaceuticalRouteOfAdministration[] {
      if (this.routeOfAdministration == undefined || this.routeOfAdministration == null ) { return defaultValue; }
      return this.routeOfAdministration;
  }
