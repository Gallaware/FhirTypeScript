 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Library
 */
export class Library {
  ...
  protected parameter?: ParameterDefinition[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(LibraryStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = LibraryStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getLibraryStatusValidValues(): string[] {
    return LibraryStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addParameter(newValue: ParameterDefinition) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteParameterAll(): ParameterDefinition[] {
    if (typeof(this.parameter) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteParameterBySplice(start: number, deleteCount?: number): ParameterDefinition[] {
    if (typeof(this.parameter) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getParameter(): ParameterDefinition[] | undefined {
  ...
  * @returns the value or the parameter value
  */
  public getParameterOrElse(defaultValue: ParameterDefinition[]): ParameterDefinition[] {
  ...
  */
  ...
  public addContent(newValue: Attachment) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteContentAll(): Attachment[] {
    if (typeof(this.content) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteContentBySplice(start: number, deleteCount?: number): Attachment[] {
    if (typeof(this.content) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getContent(): Attachment[] | undefined {
      return this.content;
  }
  ...
  * @returns the value or the parameter value
  */
  public getContentOrElse(defaultValue: Attachment[]): Attachment[] {
