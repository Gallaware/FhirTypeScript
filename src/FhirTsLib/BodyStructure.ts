 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/BodyStructure
 */
export class BodyStructure {
   ...
   */
  @Type(() => CodeableConcept)
  protected locationQualifier?: CodeableConcept[];
  ...
  */
  ...
  public addLocationQualifier(newValue: CodeableConcept) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array locationQualifier, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteLocationQualifierAll(): CodeableConcept[] {
    if (typeof(this.locationQualifier) !== 'undefined') {
       const oldArray = this.locationQualifier;
       delete this.locationQualifier;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array locationQualifier, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteLocationQualifierBySplice(start: number, deleteCount?: number): CodeableConcept[] {
    if (typeof(this.locationQualifier) !== 'undefined') {
       return this.locationQualifier.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field locationQualifier.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field locationQualifier if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getLocationQualifierOrElse(defaultValue: CodeableConcept[]): CodeableConcept[] {
      if (this.locationQualifier == undefined || this.locationQualifier == null ) { return defaultValue; }
      return this.locationQualifier;
  }
