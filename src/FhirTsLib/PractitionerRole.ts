...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_AVAILABILITYEXCEPTIONS } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, ContactPoint, Element, Extension, Identifier, Meta, Narrative, Period, PractitionerRoleAvailableTime, PractitionerRoleNotAvailable, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/PractitionerRole
 */
export class PractitionerRole {
   ...
   */
  @Type(() => Reference)
  protected healthcareService?: Reference[];
  ...
  protected availableTime?: PractitionerRoleAvailableTime[];
  ...
  protected notAvailable?: PractitionerRoleNotAvailable[];
  ...
  */
  ...
  public addHealthcareService(newValue: Reference) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array healthcareService, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteHealthcareServiceAll(): Reference[] {
    if (typeof(this.healthcareService) !== 'undefined') {
       const oldArray = this.healthcareService;
       delete this.healthcareService;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array healthcareService, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteHealthcareServiceBySplice(start: number, deleteCount?: number): Reference[] {
    if (typeof(this.healthcareService) !== 'undefined') {
       return this.healthcareService.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field healthcareService.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  public addAvailableTime(newValue: PractitionerRoleAvailableTime) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteAvailableTimeAll(): PractitionerRoleAvailableTime[] {
    if (typeof(this.availableTime) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteAvailableTimeBySplice(start: number, deleteCount?: number): PractitionerRoleAvailableTime[] {
    if (typeof(this.availableTime) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getAvailableTimeOrElse(defaultValue: PractitionerRoleAvailableTime[]): PractitionerRoleAvailableTime[] {
      if (this.availableTime == undefined || this.availableTime == null ) { return defaultValue; }
      return this.availableTime;
  }

  public addNotAvailable(newValue: PractitionerRoleNotAvailable) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteNotAvailableAll(): PractitionerRoleNotAvailable[] {
    if (typeof(this.notAvailable) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteNotAvailableBySplice(start: number, deleteCount?: number): PractitionerRoleNotAvailable[] {
    if (typeof(this.notAvailable) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getNotAvailableOrElse(defaultValue: PractitionerRoleNotAvailable[]): PractitionerRoleNotAvailable[] {
