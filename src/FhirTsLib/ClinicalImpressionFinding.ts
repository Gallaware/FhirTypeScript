...
import { REGEX_ID, REGEX_BASIS } from '../FhirTsLibValidation/FhirRegex';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ClinicalImpression_Finding
 */
export class ClinicalImpressionFinding {
  ...
  * that should be caught.
  */
  public setBasis(newValue: string) {
    if (typeof(newValue) === 'undefined') {
    ...
    if (REGEX_BASIS.test(newValue)) {
      this.basis = newValue
    } else {
      throw new Error("Invalid value pattern for basis of " + newValue);
    }
  }
  
  public getBasisPattern(): string {
    return REGEX_BASIS.source;
  }
  ...
  * @returns the value  or undefined
  */
  public getBasis(): string | undefined {
      return this.basis;
  }

  /**
  * Gets the current value of field basis if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getBasisOrElse(defaultValue: string): string {
      if (this.basis == undefined || this.basis == null ) { return defaultValue; }
      return this.basis;
  }
