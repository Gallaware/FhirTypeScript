...
export class EffectEvidenceSynthesisResultsByExposure {
  ...
  */
  ...
  /**
  * Gets the current value of field exposureState.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field exposureState if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getExposureStateOrElse(defaultValue: string): string {
      if (this.exposureState == undefined || this.exposureState == null ) { return defaultValue; }
      return this.exposureState;
  }
