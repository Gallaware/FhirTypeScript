...
import { Element, Extension, TerminologyCapabilitiesVersion } from './index';
...
export class TerminologyCapabilitiesCodeSystem {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteVersionAll(): TerminologyCapabilitiesVersion[] {
    if (typeof(this.version) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteVersionBySplice(start: number, deleteCount?: number): TerminologyCapabilitiesVersion[] {
    if (typeof(this.version) !== 'undefined') {
