...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_CANCELLEDREASON, REGEX_DATE, REGEX_PAYMENTTERMS } from '../FhirTsLibValidation/FhirRegex';
import { Annotation, CodeableConcept, Element, Extension, Identifier, InvoiceLineItem, InvoiceParticipant, InvoicePriceComponent, Meta, Money, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription } from './index';
import { InvoiceStatus_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Invoice
 */
export class Invoice {
   ...
   * Field access restricted because there are specific valid values.
   */
  protected cancelledReason?: string;
  ...
  protected participant?: InvoiceParticipant[];
  ...
  protected lineItem?: InvoiceLineItem[];
  ...
  protected totalPriceComponent?: InvoicePriceComponent[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(InvoiceStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = InvoiceStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getInvoiceStatusValidValues(): string[] {
    return InvoiceStatus_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setCancelledReason(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.cancelledReason) !== 'undefined') {
         delete this.cancelledReason;
      }
      return;
    }
    
    if (REGEX_CANCELLEDREASON.test(newValue)) {
      this.cancelledReason = newValue
    } else {
      throw new Error("Invalid value pattern for cancelledReason of " + newValue);
    }
  }
  
  public getCancelledReasonPattern(): string {
    return REGEX_CANCELLEDREASON.source;
  }
  
  /**
  * Gets the current value of field cancelledReason.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field cancelledReason if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getCancelledReasonOrElse(defaultValue: string): string {
      if (this.cancelledReason == undefined || this.cancelledReason == null ) { return defaultValue; }
      return this.cancelledReason;
  }
  ...
  */
  ...
  public addParticipant(newValue: InvoiceParticipant) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteParticipantAll(): InvoiceParticipant[] {
    if (typeof(this.participant) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteParticipantBySplice(start: number, deleteCount?: number): InvoiceParticipant[] {
    if (typeof(this.participant) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getParticipantOrElse(defaultValue: InvoiceParticipant[]): InvoiceParticipant[] {
      if (this.participant == undefined || this.participant == null ) { return defaultValue; }
      return this.participant;
  }

  public addLineItem(newValue: InvoiceLineItem) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array lineItem, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteLineItemAll(): InvoiceLineItem[] {
    if (typeof(this.lineItem) !== 'undefined') {
       const oldArray = this.lineItem;
       delete this.lineItem;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array lineItem, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteLineItemBySplice(start: number, deleteCount?: number): InvoiceLineItem[] {
    if (typeof(this.lineItem) !== 'undefined') {
       return this.lineItem.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field lineItem.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field lineItem if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getLineItemOrElse(defaultValue: InvoiceLineItem[]): InvoiceLineItem[] {
      if (this.lineItem == undefined || this.lineItem == null ) { return defaultValue; }
      return this.lineItem;
  }

  public addTotalPriceComponent(newValue: InvoicePriceComponent) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array totalPriceComponent, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteTotalPriceComponentAll(): InvoicePriceComponent[] {
    if (typeof(this.totalPriceComponent) !== 'undefined') {
       const oldArray = this.totalPriceComponent;
       delete this.totalPriceComponent;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array totalPriceComponent, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteTotalPriceComponentBySplice(start: number, deleteCount?: number): InvoicePriceComponent[] {
    if (typeof(this.totalPriceComponent) !== 'undefined') {
       return this.totalPriceComponent.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field totalPriceComponent.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field totalPriceComponent if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getTotalPriceComponentOrElse(defaultValue: InvoicePriceComponent[]): InvoicePriceComponent[] {
      if (this.totalPriceComponent == undefined || this.totalPriceComponent == null ) { return defaultValue; }
      return this.totalPriceComponent;
  }
  ...
  * that should be caught.
  */
  public setPaymentTerms(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.paymentTerms) !== 'undefined') {
         delete this.paymentTerms;
      }
      return;
    }
    
    if (REGEX_PAYMENTTERMS.test(newValue)) {
      this.paymentTerms = newValue
    } else {
      throw new Error("Invalid value pattern for paymentTerms of " + newValue);
    }
  }
  
  public getPaymentTermsPattern(): string {
    return REGEX_PAYMENTTERMS.source;
  }
  
  /**
  * Gets the current value of field paymentTerms.
  * @returns the value  or undefined
  */
  public getPaymentTerms(): string | undefined {
      return this.paymentTerms;
  }

  /**
  * Gets the current value of field paymentTerms if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getPaymentTermsOrElse(defaultValue: string): string {
      if (this.paymentTerms == undefined || this.paymentTerms == null ) { return defaultValue; }
      return this.paymentTerms;
  }
