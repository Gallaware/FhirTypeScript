...
import { CodeableConcept, Element, ExplanationOfBenefitFinancial, Extension } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ExplanationOfBenefit_BenefitBalance
 */
export class ExplanationOfBenefitBenefitBalance {
  ...
  protected financial?: ExplanationOfBenefitFinancial[];
  ...
  */
  ...
  public addFinancial(newValue: ExplanationOfBenefitFinancial) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array financial, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteFinancialAll(): ExplanationOfBenefitFinancial[] {
    if (typeof(this.financial) !== 'undefined') {
       const oldArray = this.financial;
       delete this.financial;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array financial, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteFinancialBySplice(start: number, deleteCount?: number): ExplanationOfBenefitFinancial[] {
    if (typeof(this.financial) !== 'undefined') {
       return this.financial.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field financial.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field financial if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getFinancialOrElse(defaultValue: ExplanationOfBenefitFinancial[]): ExplanationOfBenefitFinancial[] {
      if (this.financial == undefined || this.financial == null ) { return defaultValue; }
      return this.financial;
  }
