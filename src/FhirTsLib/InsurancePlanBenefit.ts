...
import { CodeableConcept, Element, Extension, InsurancePlanLimit } from './index';
...
export class InsurancePlanBenefit {
  ...
  */
  ...
  /**
  * Removes all elements from the array limit, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteLimitAll(): InsurancePlanLimit[] {
    if (typeof(this.limit) !== 'undefined') {
       const oldArray = this.limit;
       delete this.limit;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array limit, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteLimitBySplice(start: number, deleteCount?: number): InsurancePlanLimit[] {
    if (typeof(this.limit) !== 'undefined') {
       return this.limit.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field limit.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field limit if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getLimitOrElse(defaultValue: InsurancePlanLimit[]): InsurancePlanLimit[] {
      if (this.limit == undefined || this.limit == null ) { return defaultValue; }
      return this.limit;
  }
