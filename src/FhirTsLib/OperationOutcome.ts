 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/OperationOutcome
 */
export class OperationOutcome {
  ...
  protected issue?: OperationOutcomeIssue[];
  ...
  */
  ...
  public addIssue(newValue: OperationOutcomeIssue) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array issue, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteIssueAll(): OperationOutcomeIssue[] {
    if (typeof(this.issue) !== 'undefined') {
       const oldArray = this.issue;
       delete this.issue;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array issue, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteIssueBySplice(start: number, deleteCount?: number): OperationOutcomeIssue[] {
    if (typeof(this.issue) !== 'undefined') {
       return this.issue.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field issue.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field issue if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getIssueOrElse(defaultValue: OperationOutcomeIssue[]): OperationOutcomeIssue[] {
      if (this.issue == undefined || this.issue == null ) { return defaultValue; }
      return this.issue;
  }
