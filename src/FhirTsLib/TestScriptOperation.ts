...
import { Coding, Element, Extension, TestScriptRequestHeader } from './index';
...
export class TestScriptOperation {
  ...
  */
  ...
  /**
  * Gets the current value of field accept.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  /**
  * Gets the current value of field method.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  /**
  * Removes all elements from the array requestHeader, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteRequestHeaderAll(): TestScriptRequestHeader[] {
    if (typeof(this.requestHeader) !== 'undefined') {
       const oldArray = this.requestHeader;
       delete this.requestHeader;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array requestHeader, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteRequestHeaderBySplice(start: number, deleteCount?: number): TestScriptRequestHeader[] {
    if (typeof(this.requestHeader) !== 'undefined') {
       return this.requestHeader.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field requestHeader.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  /**
  * Gets the current value of field requestId.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  /**
  * Gets the current value of field responseId.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  /**
  * Gets the current value of field targetId.
  * @returns the value  or undefined
  */
