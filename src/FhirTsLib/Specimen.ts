...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_RECEIVEDTIME } from '../FhirTsLibValidation/FhirRegex';
import { Annotation, CodeableConcept, Element, Extension, Identifier, Meta, Narrative, Reference, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, SpecimenCollection, SpecimenContainer, SpecimenProcessing } from './index';
import { SpecimenStatus_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Specimen
 */
export class Specimen {
  ...
  /**
   * Reference to the parent (source) specimen which is used when the specimen was either derived from
   * or a component of another specimen.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Reference)
  protected parent?: Reference[];
  ...
  protected processing?: SpecimenProcessing[];
  ...
  protected container?: SpecimenContainer[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(SpecimenStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = SpecimenStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getSpecimenStatusValidValues(): string[] {
    return SpecimenStatus_list_ValidValues;
  }
  ...
  * that should be caught.
  */
  public setReceivedTime(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.receivedTime) !== 'undefined') {
         delete this.receivedTime;
      }
      return;
    }
    
    if (REGEX_RECEIVEDTIME.test(newValue)) {
      this.receivedTime = newValue
    } else {
      throw new Error("Invalid value pattern for receivedTime of " + newValue);
    }
  }
  
  public getReceivedTimePattern(): string {
    return REGEX_RECEIVEDTIME.source;
  }
  
  /**
  * Gets the current value of field receivedTime.
  * @returns the value  or undefined
  */
  ...
  */
  ...
  public addProcessing(newValue: SpecimenProcessing) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteProcessingAll(): SpecimenProcessing[] {
    if (typeof(this.processing) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteProcessingBySplice(start: number, deleteCount?: number): SpecimenProcessing[] {
    if (typeof(this.processing) !== 'undefined') {
  ...
  */
  ...
  /**
  * Removes all elements from the array container, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteContainerAll(): SpecimenContainer[] {
    if (typeof(this.container) !== 'undefined') {
       const oldArray = this.container;
       delete this.container;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array container, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteContainerBySplice(start: number, deleteCount?: number): SpecimenContainer[] {
    if (typeof(this.container) !== 'undefined') {
       return this.container.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field container.
  * @returns the value  or undefined
  */
