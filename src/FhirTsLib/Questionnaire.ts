 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Questionnaire
 */
export class Questionnaire {
   ...
   */
  @Type(() => Element)
  protected _subjectType?: Element[];
  ...
  */
  ...
  public addDerivedFrom(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteDerivedFromAll(): string[] {
    if (typeof(this.derivedFrom) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteDerivedFromBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.derivedFrom) !== 'undefined') {
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(QuestionnaireStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = QuestionnaireStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getQuestionnaireStatusValidValues(): string[] {
    return QuestionnaireStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addSubjectType(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.subjectType) !== 'undefined') {
         delete this.subjectType;
      }
      return;
    }
    ...
    this.subjectType.push(newValue);
  }
  /**
  * Removes all elements from the array subjectType, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteSubjectTypeAll(): string[] {
    if (typeof(this.subjectType) !== 'undefined') {
       const oldArray = this.subjectType;
       delete this.subjectType;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array subjectType, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteSubjectTypeBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.subjectType) !== 'undefined') {
       return this.subjectType.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field subjectType.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field subjectType if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getSubjectTypeOrElse(defaultValue: string[]): string[] {
      if (this.subjectType == undefined || this.subjectType == null ) { return defaultValue; }
      return this.subjectType;
  }

  public add_subjectType(newValue: Element) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this._subjectType) !== 'undefined') {
         delete this._subjectType;
      }
      return;
    }
    ...
    this._subjectType.push(newValue);
  }
  /**
  * Removes all elements from the array _subjectType, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public delete_subjectTypeAll(): Element[] {
    if (typeof(this._subjectType) !== 'undefined') {
       const oldArray = this._subjectType;
       delete this._subjectType;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array _subjectType, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public delete_subjectTypeBySplice(start: number, deleteCount?: number): Element[] {
    if (typeof(this._subjectType) !== 'undefined') {
       return this._subjectType.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field _subjectType.
  * @returns the value  or undefined
  */
  public get_subjectType(): Element[] | undefined {
      return this._subjectType;
  }

  /**
  * Gets the current value of field _subjectType if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public get_subjectTypeOrElse(defaultValue: Element[]): Element[] {
      if (this._subjectType == undefined || this._subjectType == null ) { return defaultValue; }
      return this._subjectType;
  }
