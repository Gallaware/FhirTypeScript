 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Group
 */
export class Group {
  /**
  ...
  protected characteristic?: GroupCharacteristic[];
  ...
  */
  public setType(newValue: string) {
    ...
    const idx = getValidValueIdx(GroupType_list_ValidValues, newValue);
    if (idx >= 0) {
      this.type = GroupType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown type of " + newValue);
    }
  }
  
  public getGroupTypeValidValues(): string[] {
    return GroupType_list_ValidValues;
  }
  ...
  */
  ...
  public addCharacteristic(newValue: GroupCharacteristic) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteCharacteristicAll(): GroupCharacteristic[] {
    if (typeof(this.characteristic) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteCharacteristicBySplice(start: number, deleteCount?: number): GroupCharacteristic[] {
    if (typeof(this.characteristic) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getCharacteristicOrElse(defaultValue: GroupCharacteristic[]): GroupCharacteristic[] {
      if (this.characteristic == undefined || this.characteristic == null ) { return defaultValue; }
      return this.characteristic;
  }

  public addMember(newValue: GroupMember) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array member, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteMemberAll(): GroupMember[] {
    if (typeof(this.member) !== 'undefined') {
       const oldArray = this.member;
       delete this.member;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array member, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteMemberBySplice(start: number, deleteCount?: number): GroupMember[] {
    if (typeof(this.member) !== 'undefined') {
       return this.member.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field member.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field member if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getMemberOrElse(defaultValue: GroupMember[]): GroupMember[] {
      if (this.member == undefined || this.member == null ) { return defaultValue; }
      return this.member;
  }
