 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/SubstanceNucleicAcid
 */
export class SubstanceNucleicAcid {
   ...
   * Field access restricted because there are specific valid values.
   */
  protected areaOfHybridisation?: string;
  ...
  protected subunit?: SubstanceNucleicAcidSubunit[];
  ...
  * that should be caught.
  */
  public setAreaOfHybridisation(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.areaOfHybridisation) !== 'undefined') {
         delete this.areaOfHybridisation;
      }
      return;
    }
    
    if (REGEX_AREAOFHYBRIDISATION.test(newValue)) {
      this.areaOfHybridisation = newValue
    } else {
      throw new Error("Invalid value pattern for areaOfHybridisation of " + newValue);
    }
  }
  
  public getAreaOfHybridisationPattern(): string {
    return REGEX_AREAOFHYBRIDISATION.source;
  }
  
  /**
  * Gets the current value of field areaOfHybridisation.
  * @returns the value  or undefined
  */
  public getAreaOfHybridisation(): string | undefined {
      return this.areaOfHybridisation;
  }

  /**
  * Gets the current value of field areaOfHybridisation if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getAreaOfHybridisationOrElse(defaultValue: string): string {
      if (this.areaOfHybridisation == undefined || this.areaOfHybridisation == null ) { return defaultValue; }
      return this.areaOfHybridisation;
  }

  public addSubunit(newValue: SubstanceNucleicAcidSubunit) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteSubunitAll(): SubstanceNucleicAcidSubunit[] {
    if (typeof(this.subunit) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteSubunitBySplice(start: number, deleteCount?: number): SubstanceNucleicAcidSubunit[] {
    if (typeof(this.subunit) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getSubunitOrElse(defaultValue: SubstanceNucleicAcidSubunit[]): SubstanceNucleicAcidSubunit[] {
