...
export class ImplementationGuideTemplate {
  ...
  */
  ...
  /**
  * Gets the current value of field scope.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field scope if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getScopeOrElse(defaultValue: string): string {
      if (this.scope == undefined || this.scope == null ) { return defaultValue; }
      return this.scope;
  }
