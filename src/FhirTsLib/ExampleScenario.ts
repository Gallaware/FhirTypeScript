...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_URL, REGEX_VERSION, REGEX_NAME, REGEX_DATE, REGEX_PUBLISHER, REGEX_COPYRIGHT, REGEX_PURPOSE } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, ContactDetail, Element, ExampleScenarioActor, ExampleScenarioInstance, ExampleScenarioProcess, Extension, Identifier, Meta, Narrative, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageDefinition, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, UsageContext } from './index';
import { ExampleScenarioStatus_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ExampleScenario
 */
export class ExampleScenario {
  ...
  protected actor?: ExampleScenarioActor[];
  ...
  protected instance?: ExampleScenarioInstance[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(ExampleScenarioStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = ExampleScenarioStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getExampleScenarioStatusValidValues(): string[] {
    return ExampleScenarioStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addActor(newValue: ExampleScenarioActor) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteActorAll(): ExampleScenarioActor[] {
    if (typeof(this.actor) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteActorBySplice(start: number, deleteCount?: number): ExampleScenarioActor[] {
    if (typeof(this.actor) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getActorOrElse(defaultValue: ExampleScenarioActor[]): ExampleScenarioActor[] {
      if (this.actor == undefined || this.actor == null ) { return defaultValue; }
      return this.actor;
  }

  public addInstance(newValue: ExampleScenarioInstance) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteInstanceAll(): ExampleScenarioInstance[] {
    if (typeof(this.instance) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteInstanceBySplice(start: number, deleteCount?: number): ExampleScenarioInstance[] {
    if (typeof(this.instance) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getInstanceOrElse(defaultValue: ExampleScenarioInstance[]): ExampleScenarioInstance[] {
  ...
  */
  ...
  public addWorkflow(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array workflow, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteWorkflowAll(): string[] {
    if (typeof(this.workflow) !== 'undefined') {
       const oldArray = this.workflow;
       delete this.workflow;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array workflow, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteWorkflowBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.workflow) !== 'undefined') {
       return this.workflow.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field workflow.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field workflow if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getWorkflowOrElse(defaultValue: string[]): string[] {
      if (this.workflow == undefined || this.workflow == null ) { return defaultValue; }
      return this.workflow;
  }
