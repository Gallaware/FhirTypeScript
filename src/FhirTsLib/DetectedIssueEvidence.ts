 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/DetectedIssue_Evidence
 */
export class DetectedIssueEvidence {
  ...
  /**
   * Links to resources that constitute evidence for the detected issue such as a GuidanceResponse or
   * MeasureReport.
   * Field access restricted because there are specific valid values.
   */
  @Type(() => Reference)
