...
import { REGEX_ID_000, REGEX_IMPLICITRULES, REGEX_LANGUAGE, REGEX_URL, REGEX_VERSION, REGEX_NAME, REGEX_TITLE, REGEX_DATE, REGEX_PUBLISHER, REGEX_DESCRIPTION, REGEX_PURPOSE, REGEX_COPYRIGHT, REGEX_BASE, REGEX_EVENTURI } from '../FhirTsLibValidation/FhirRegex';
import { CodeableConcept, Coding, ContactDetail, Element, Extension, Identifier, MessageDefinitionAllowedResponse, MessageDefinitionFocus, Meta, Narrative, ResourceList, Account, ActivityDefinition, AdverseEvent, AllergyIntolerance, Appointment, AppointmentResponse, AuditEvent, Basic, Binary, BiologicallyDerivedProduct, BodyStructure, Bundle, CapabilityStatement, CarePlan, CareTeam, CatalogEntry, ChargeItem, ChargeItemDefinition, Claim, ClaimResponse, ClinicalImpression, CodeSystem, Communication, CommunicationRequest, CompartmentDefinition, Composition, ConceptMap, Condition, Consent, Contract, Coverage, CoverageEligibilityRequest, CoverageEligibilityResponse, DetectedIssue, Device, DeviceDefinition, DeviceMetric, DeviceRequest, DeviceUseStatement, DiagnosticReport, DocumentManifest, DocumentReference, EffectEvidenceSynthesis, Encounter, Endpoint, EnrollmentRequest, EnrollmentResponse, EpisodeOfCare, EventDefinition, Evidence, EvidenceVariable, ExampleScenario, ExplanationOfBenefit, FamilyMemberHistory, Flag, Goal, GraphDefinition, Group, GuidanceResponse, HealthcareService, ImagingStudy, Immunization, ImmunizationEvaluation, ImmunizationRecommendation, ImplementationGuide, InsurancePlan, Invoice, Library, Linkage, List, Location, Measure, MeasureReport, Media, Medication, MedicationAdministration, MedicationDispense, MedicationKnowledge, MedicationRequest, MedicationStatement, MedicinalProduct, MedicinalProductAuthorization, MedicinalProductContraindication, MedicinalProductIndication, MedicinalProductIngredient, MedicinalProductInteraction, MedicinalProductManufactured, MedicinalProductPackaged, MedicinalProductPharmaceutical, MedicinalProductUndesirableEffect, MessageHeader, MolecularSequence, NamingSystem, NutritionOrder, Observation, ObservationDefinition, OperationDefinition, OperationOutcome, Organization, OrganizationAffiliation, Parameters, Patient, PaymentNotice, PaymentReconciliation, Person, PlanDefinition, Practitioner, PractitionerRole, Procedure, Provenance, Questionnaire, QuestionnaireResponse, RelatedPerson, RequestGroup, ResearchDefinition, ResearchElementDefinition, ResearchStudy, ResearchSubject, RiskAssessment, RiskEvidenceSynthesis, Schedule, SearchParameter, ServiceRequest, Slot, Specimen, SpecimenDefinition, StructureDefinition, StructureMap, Subscription, Substance, SubstanceNucleicAcid, SubstancePolymer, SubstanceProtein, SubstanceReferenceInformation, SubstanceSourceMaterial, SubstanceSpecification, SupplyDelivery, SupplyRequest, Task, TerminologyCapabilities, TestReport, TestScript, ValueSet, VerificationResult, VisionPrescription, UsageContext } from './index';
import { MessageDefinitionStatus_list_ValidValues, MessageDefinitionCategory_list_ValidValues, MessageDefinitionResponseRequired_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/MessageDefinition
 */
export class MessageDefinition {
  ...
  protected focus?: MessageDefinitionFocus[];
   ...
   * Field access restricted because there are specific valid values.
   */
  protected responseRequired?: string;
  ...
  protected allowedResponse?: MessageDefinitionAllowedResponse[];

  /**
   * Canonical reference to a GraphDefinition. If a URL is provided, it is the canonical reference to a
   * [[[GraphDefinition]]] that it controls what resources are to be added to the bundle when building
   * the document. The GraphDefinition can also specify profiles that apply to the various resources.
   * Field access restricted because there are specific valid values.
   */
  ...
  * @returns the value or the parameter value
  */
  public getReplacesOrElse(defaultValue: string[]): string[] {
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(MessageDefinitionStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = MessageDefinitionStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getMessageDefinitionStatusValidValues(): string[] {
    return MessageDefinitionStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addParent(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  *     was undefined.
  */
  public deleteParentBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.parent) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getParentOrElse(defaultValue: string[]): string[] {
  ...
  */
  public setCategory(newValue: string) {
    ...
    const idx = getValidValueIdx(MessageDefinitionCategory_list_ValidValues, newValue);
    if (idx >= 0) {
      this.category = MessageDefinitionCategory_list_ValidValues[idx];
    } else {
      throw new Error("Unknown category of " + newValue);
    }
  }
  
  public getMessageDefinitionCategoryValidValues(): string[] {
    return MessageDefinitionCategory_list_ValidValues;
  }
  ...
  */
  ...
  public addFocus(newValue: MessageDefinitionFocus) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteFocusAll(): MessageDefinitionFocus[] {
    if (typeof(this.focus) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteFocusBySplice(start: number, deleteCount?: number): MessageDefinitionFocus[] {
    if (typeof(this.focus) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getFocusOrElse(defaultValue: MessageDefinitionFocus[]): MessageDefinitionFocus[] {
  ...
  * that should be caught.
  */
  public setResponseRequired(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.responseRequired) !== 'undefined') {
         delete this.responseRequired;
      }
      return;
    }
    
    const idx = getValidValueIdx(MessageDefinitionResponseRequired_list_ValidValues, newValue);
    if (idx >= 0) {
      this.responseRequired = MessageDefinitionResponseRequired_list_ValidValues[idx];
    } else {
      throw new Error("Unknown responseRequired of " + newValue);
    }
  }
  
  public getMessageDefinitionResponseRequiredValidValues(): string[] {
    return MessageDefinitionResponseRequired_list_ValidValues;
  }
  
  /**
  * Gets the current value of field responseRequired.
  * @returns the value  or undefined
  */
  public getResponseRequired(): string | undefined {
      return this.responseRequired;
  }

  /**
  * Gets the current value of field responseRequired if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getResponseRequiredOrElse(defaultValue: string): string {
      if (this.responseRequired == undefined || this.responseRequired == null ) { return defaultValue; }
      return this.responseRequired;
  }

  public addAllowedResponse(newValue: MessageDefinitionAllowedResponse) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array allowedResponse, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteAllowedResponseAll(): MessageDefinitionAllowedResponse[] {
    if (typeof(this.allowedResponse) !== 'undefined') {
       const oldArray = this.allowedResponse;
       delete this.allowedResponse;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array allowedResponse, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteAllowedResponseBySplice(start: number, deleteCount?: number): MessageDefinitionAllowedResponse[] {
    if (typeof(this.allowedResponse) !== 'undefined') {
       return this.allowedResponse.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field allowedResponse.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field allowedResponse if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getAllowedResponseOrElse(defaultValue: MessageDefinitionAllowedResponse[]): MessageDefinitionAllowedResponse[] {
      if (this.allowedResponse == undefined || this.allowedResponse == null ) { return defaultValue; }
      return this.allowedResponse;
  }

  public addGraph(newValue: string) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array graph, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteGraphAll(): string[] {
    if (typeof(this.graph) !== 'undefined') {
       const oldArray = this.graph;
       delete this.graph;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array graph, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteGraphBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.graph) !== 'undefined') {
       return this.graph.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field graph.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field graph if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getGraphOrElse(defaultValue: string[]): string[] {
      if (this.graph == undefined || this.graph == null ) { return defaultValue; }
      return this.graph;
  }
