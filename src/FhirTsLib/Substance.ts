 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Substance
 */
export class Substance {
  ...
  protected instance?: SubstanceInstance[];
  ...
  protected ingredient?: SubstanceIngredient[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(SubstanceStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = SubstanceStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getSubstanceStatusValidValues(): string[] {
    return SubstanceStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addInstance(newValue: SubstanceInstance) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteInstanceAll(): SubstanceInstance[] {
    if (typeof(this.instance) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteInstanceBySplice(start: number, deleteCount?: number): SubstanceInstance[] {
    if (typeof(this.instance) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getInstanceOrElse(defaultValue: SubstanceInstance[]): SubstanceInstance[] {
      if (this.instance == undefined || this.instance == null ) { return defaultValue; }
      return this.instance;
  }

  public addIngredient(newValue: SubstanceIngredient) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteIngredientAll(): SubstanceIngredient[] {
    if (typeof(this.ingredient) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteIngredientBySplice(start: number, deleteCount?: number): SubstanceIngredient[] {
    if (typeof(this.ingredient) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getIngredientOrElse(defaultValue: SubstanceIngredient[]): SubstanceIngredient[] {
