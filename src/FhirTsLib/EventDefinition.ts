 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/EventDefinition
 */
export class EventDefinition {
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(EventDefinitionStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = EventDefinitionStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getEventDefinitionStatusValidValues(): string[] {
    return EventDefinitionStatus_list_ValidValues;
  }
