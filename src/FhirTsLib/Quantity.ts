...
import { QuantityComparator_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Quantity
 */
export class Quantity {
  ...
  */
  public setComparator(newValue: string) {
    ...
    const idx = getValidValueIdx(QuantityComparator_list_ValidValues, newValue);
    if (idx >= 0) {
      this.comparator = QuantityComparator_list_ValidValues[idx];
    } else {
      throw new Error("Unknown comparator of " + newValue);
    }
  }
  
  public getQuantityComparatorValidValues(): string[] {
