 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/GraphDefinition
 */
export class GraphDefinition {
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(GraphDefinitionStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = GraphDefinitionStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getGraphDefinitionStatusValidValues(): string[] {
    return GraphDefinitionStatus_list_ValidValues;
  }
  ...
  */
  public setStart(newValue: string) {
    ...
    if (idx >= 0) {
      this.start = ResourceType_list_ValidValues[idx];
    } else {
      throw new Error("Unknown start of " + newValue);
    }
  }
  
  public getGraphDefinitionStartValidValues(): string[] {
