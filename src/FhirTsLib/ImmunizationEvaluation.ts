 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ImmunizationEvaluation
 */
export class ImmunizationEvaluation {
   ...
   */
  @Type(() => CodeableConcept)
  protected doseStatusReason?: CodeableConcept[];
  ...
  */
  ...
  public addDoseStatusReason(newValue: CodeableConcept) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array doseStatusReason, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteDoseStatusReasonAll(): CodeableConcept[] {
    if (typeof(this.doseStatusReason) !== 'undefined') {
       const oldArray = this.doseStatusReason;
       delete this.doseStatusReason;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array doseStatusReason, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteDoseStatusReasonBySplice(start: number, deleteCount?: number): CodeableConcept[] {
    if (typeof(this.doseStatusReason) !== 'undefined') {
       return this.doseStatusReason.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field doseStatusReason.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field doseStatusReason if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getDoseStatusReasonOrElse(defaultValue: CodeableConcept[]): CodeableConcept[] {
      if (this.doseStatusReason == undefined || this.doseStatusReason == null ) { return defaultValue; }
      return this.doseStatusReason;
  }
