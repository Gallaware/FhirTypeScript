...
export class ImplementationGuidePage1 {
  ...
  */
  ...
  /**
  * Gets the current value of field anchor if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getAnchorOrElse(defaultValue: string[]): string[] {
      if (this.anchor == undefined || this.anchor == null ) { return defaultValue; }
      return this.anchor;
  }
  ...
  */
  ...
  /**
  * Gets the current value of field _anchor if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public get_anchorOrElse(defaultValue: Element[]): Element[] {
      if (this._anchor == undefined || this._anchor == null ) { return defaultValue; }
      return this._anchor;
  }
