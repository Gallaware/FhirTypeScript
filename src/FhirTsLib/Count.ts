...
import { CountComparator_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Count
 */
export class Count {
  /**
  ...
  */
  public setComparator(newValue: string) {
    ...
    const idx = getValidValueIdx(CountComparator_list_ValidValues, newValue);
    if (idx >= 0) {
      this.comparator = CountComparator_list_ValidValues[idx];
    } else {
      throw new Error("Unknown comparator of " + newValue);
    }
  }
  
  public getCountComparatorValidValues(): string[] {
    return CountComparator_list_ValidValues;
  }
