...
import { ContactPoint, Element, Extension } from './index';
...
export class MessageHeaderSource {
  ...
  */
  ...
  /**
  * Gets the current value of field software.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field software if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getSoftwareOrElse(defaultValue: string): string {
      if (this.software == undefined || this.software == null ) { return defaultValue; }
      return this.software;
  }
