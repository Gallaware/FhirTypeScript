 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/SubstanceProtein
 */
export class SubstanceProtein {
  /**
   ...
   * abbreviation of the amino acids involved. The disulfide linkage positions shall actually contain
   * the amino acid Cysteine at the respective positions.
   * Field access restricted because there are specific valid values.
   */
  protected disulfideLinkage?: string[];
   ...
   */
  @Type(() => Element)
  protected _disulfideLinkage?: Element[];
  ...
  protected subunit?: SubstanceProteinSubunit[];
  ...
  */
  ...
  /**
  * Removes all elements from the array disulfideLinkage, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteDisulfideLinkageAll(): string[] {
    if (typeof(this.disulfideLinkage) !== 'undefined') {
       const oldArray = this.disulfideLinkage;
       delete this.disulfideLinkage;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array disulfideLinkage, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteDisulfideLinkageBySplice(start: number, deleteCount?: number): string[] {
    if (typeof(this.disulfideLinkage) !== 'undefined') {
       return this.disulfideLinkage.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field disulfideLinkage.
  * @returns the value  or undefined
  */
  ...
  public add_disulfideLinkage(newValue: Element) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array _disulfideLinkage, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public delete_disulfideLinkageAll(): Element[] {
    if (typeof(this._disulfideLinkage) !== 'undefined') {
       const oldArray = this._disulfideLinkage;
       delete this._disulfideLinkage;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array _disulfideLinkage, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public delete_disulfideLinkageBySplice(start: number, deleteCount?: number): Element[] {
    if (typeof(this._disulfideLinkage) !== 'undefined') {
       return this._disulfideLinkage.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field _disulfideLinkage.
  * @returns the value  or undefined
  */
  ...
  /**
  * Removes all elements from the array subunit, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteSubunitAll(): SubstanceProteinSubunit[] {
    if (typeof(this.subunit) !== 'undefined') {
       const oldArray = this.subunit;
       delete this.subunit;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array subunit, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteSubunitBySplice(start: number, deleteCount?: number): SubstanceProteinSubunit[] {
    if (typeof(this.subunit) !== 'undefined') {
       return this.subunit.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field subunit.
  * @returns the value  or undefined
  */
