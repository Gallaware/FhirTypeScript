 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/PlanDefinition
 */
export class PlanDefinition {
  ...
  protected goal?: PlanDefinitionGoal[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(PlanDefinitionStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = PlanDefinitionStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getPlanDefinitionStatusValidValues(): string[] {
    return PlanDefinitionStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addGoal(newValue: PlanDefinitionGoal) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteGoalAll(): PlanDefinitionGoal[] {
    if (typeof(this.goal) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteGoalBySplice(start: number, deleteCount?: number): PlanDefinitionGoal[] {
    if (typeof(this.goal) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getGoal(): PlanDefinitionGoal[] | undefined {
      return this.goal;
  }
  ...
  * @returns the value or the parameter value
  */
  public getGoalOrElse(defaultValue: PlanDefinitionGoal[]): PlanDefinitionGoal[] {
