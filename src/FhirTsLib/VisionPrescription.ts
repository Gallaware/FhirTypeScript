 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/VisionPrescription
 */
export class VisionPrescription {
  ...
  protected lensSpecification?: VisionPrescriptionLensSpecification[];
  ...
  * that should be caught.
  */
  public setDateWritten(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.dateWritten) !== 'undefined') {
         delete this.dateWritten;
      }
      return;
    }
    
    if (REGEX_DATEWRITTEN.test(newValue)) {
      this.dateWritten = newValue
    } else {
      throw new Error("Invalid value pattern for dateWritten of " + newValue);
    }
  }
  
  public getDateWrittenPattern(): string {
    return REGEX_DATEWRITTEN.source;
  }
  
  /**
  * Gets the current value of field dateWritten.
  * @returns the value  or undefined
  */
  public getDateWritten(): string | undefined {
      return this.dateWritten;
  }

  /**
  * Gets the current value of field dateWritten if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getDateWrittenOrElse(defaultValue: string): string {
      if (this.dateWritten == undefined || this.dateWritten == null ) { return defaultValue; }
      return this.dateWritten;
  }

  public addLensSpecification(newValue: VisionPrescriptionLensSpecification) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array lensSpecification, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteLensSpecificationAll(): VisionPrescriptionLensSpecification[] {
    if (typeof(this.lensSpecification) !== 'undefined') {
       const oldArray = this.lensSpecification;
       delete this.lensSpecification;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array lensSpecification, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteLensSpecificationBySplice(start: number, deleteCount?: number): VisionPrescriptionLensSpecification[] {
    if (typeof(this.lensSpecification) !== 'undefined') {
       return this.lensSpecification.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field lensSpecification.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field lensSpecification if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getLensSpecificationOrElse(defaultValue: VisionPrescriptionLensSpecification[]): VisionPrescriptionLensSpecification[] {
      if (this.lensSpecification == undefined || this.lensSpecification == null ) { return defaultValue; }
      return this.lensSpecification;
  }
