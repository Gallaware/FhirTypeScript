...
import { Attachment, Coding, Element, Extension, Quantity, Reference } from './FhirType';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Contract_Answer
 */
export class ContractAnswer {
  /**
  ...
  /**
   * Response to an offer clause or question text,  which enables selection of values to be agreed to,
   * e.g., the period of participation, the date of occupancy of a rental, warrently duration, or
