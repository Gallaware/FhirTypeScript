...
import { Extension, TestScriptAction } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/TestScript_Setup
 */
export class TestScriptSetup {
  ...
  protected action?: TestScriptAction[];
  ...
  */
  ...
  public addAction(newValue: TestScriptAction) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteActionAll(): TestScriptAction[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteActionBySplice(start: number, deleteCount?: number): TestScriptAction[] {
    if (typeof(this.action) !== 'undefined') {
  ...
  * @returns the value  or undefined
  */
  public getAction(): TestScriptAction[] | undefined {
      return this.action;
  }
  ...
  * @returns the value or the parameter value
  */
  public getActionOrElse(defaultValue: TestScriptAction[]): TestScriptAction[] {
