 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/MedicinalProductInteraction
 */
export class MedicinalProductInteraction {
  ...
  protected interactant?: MedicinalProductInteractionInteractant[];
  ...
  */
  ...
  public addInteractant(newValue: MedicinalProductInteractionInteractant) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array interactant, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteInteractantAll(): MedicinalProductInteractionInteractant[] {
    if (typeof(this.interactant) !== 'undefined') {
       const oldArray = this.interactant;
       delete this.interactant;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array interactant, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteInteractantBySplice(start: number, deleteCount?: number): MedicinalProductInteractionInteractant[] {
    if (typeof(this.interactant) !== 'undefined') {
       return this.interactant.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field interactant.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field interactant if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getInteractantOrElse(defaultValue: MedicinalProductInteractionInteractant[]): MedicinalProductInteractionInteractant[] {
      if (this.interactant == undefined || this.interactant == null ) { return defaultValue; }
      return this.interactant;
  }
