...
import { CapabilityStatementInteractionCode_list_ValidValues } from '../FhirTsLibValidation/Fhir_ValidValues';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/CapabilityStatement_Interaction
 */
export class CapabilityStatementInteraction {
  /**
  ...
  */
  public setCode(newValue: string) {
    ...
    const idx = getValidValueIdx(CapabilityStatementInteractionCode_list_ValidValues, newValue);
    if (idx >= 0) {
      this.code = CapabilityStatementInteractionCode_list_ValidValues[idx];
    } else {
      throw new Error("Unknown code of " + newValue);
    }
  }
  
  public getCapabilityStatementInteractionCodeValidValues(): string[] {
    return CapabilityStatementInteractionCode_list_ValidValues;
  }
