 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Medication
 */
export class Medication {
  ...
  protected ingredient?: MedicationIngredient[];
  ...
  */
  ...
  public addIngredient(newValue: MedicationIngredient) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteIngredientAll(): MedicationIngredient[] {
    if (typeof(this.ingredient) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteIngredientBySplice(start: number, deleteCount?: number): MedicationIngredient[] {
    if (typeof(this.ingredient) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getIngredientOrElse(defaultValue: MedicationIngredient[]): MedicationIngredient[] {
