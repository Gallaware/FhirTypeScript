...
export class EffectEvidenceSynthesisCertainty {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteCertaintySubcomponentAll(): EffectEvidenceSynthesisCertaintySubcomponent[] {
    if (typeof(this.certaintySubcomponent) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteCertaintySubcomponentBySplice(start: number, deleteCount?: number): EffectEvidenceSynthesisCertaintySubcomponent[] {
    if (typeof(this.certaintySubcomponent) !== 'undefined') {
