 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/SupplyDelivery
 */
export class SupplyDelivery {
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(SupplyDeliveryStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = SupplyDeliveryStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getSupplyDeliveryStatusValidValues(): string[] {
    return SupplyDeliveryStatus_list_ValidValues;
  }
