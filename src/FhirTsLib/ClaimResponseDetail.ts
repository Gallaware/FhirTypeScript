...
import { ClaimResponseAdjudication, ClaimResponseSubDetail, Element, Extension } from './index';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ClaimResponse_Detail
 */
export class ClaimResponseDetail {
  ...
  protected subDetail?: ClaimResponseSubDetail[];
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteSubDetailAll(): ClaimResponseSubDetail[] {
    if (typeof(this.subDetail) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteSubDetailBySplice(start: number, deleteCount?: number): ClaimResponseSubDetail[] {
    if (typeof(this.subDetail) !== 'undefined') {
