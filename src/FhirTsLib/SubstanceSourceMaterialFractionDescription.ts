...
import { REGEX_ID, REGEX_FRACTION } from '../FhirTsLibValidation/FhirRegex';
 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/SubstanceSourceMaterial_FractionDescription
 */
export class SubstanceSourceMaterialFractionDescription {
  ...
  * that should be caught.
  */
  public setFraction(newValue: string) {
    if (typeof(newValue) === 'undefined') {
      if (typeof(this.fraction) !== 'undefined') {
         delete this.fraction;
      }
      return;
    }
    
    if (REGEX_FRACTION.test(newValue)) {
      this.fraction = newValue
    } else {
      throw new Error("Invalid value pattern for fraction of " + newValue);
    }
  }
  
  public getFractionPattern(): string {
    return REGEX_FRACTION.source;
  }
  
  /**
  * Gets the current value of field fraction.
  * @returns the value  or undefined
  */
  public getFraction(): string | undefined {
      return this.fraction;
  }

  /**
  * Gets the current value of field fraction if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getFractionOrElse(defaultValue: string): string {
      if (this.fraction == undefined || this.fraction == null ) { return defaultValue; }
      return this.fraction;
  }
