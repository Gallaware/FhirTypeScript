 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Person
 */
export class Person {
  /**
  ...
  */
  public setGender(newValue: string) {
    ...
    const idx = getValidValueIdx(PersonGender_list_ValidValues, newValue);
    if (idx >= 0) {
      this.gender = PersonGender_list_ValidValues[idx];
    } else {
      throw new Error("Unknown gender of " + newValue);
    }
  }
  
  public getPersonGenderValidValues(): string[] {
    return PersonGender_list_ValidValues;
  }
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteLinkAll(): PersonLink[] {
    if (typeof(this.link) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteLinkBySplice(start: number, deleteCount?: number): PersonLink[] {
    if (typeof(this.link) !== 'undefined') {
