 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/Account
 */
export class Account {
  ...
  protected coverage?: AccountCoverage[];
  ...
  protected guarantor?: AccountGuarantor[];
  ...
  */
  public setStatus(newValue: string) {
    ...
    const idx = getValidValueIdx(AccountStatus_list_ValidValues, newValue);
    if (idx >= 0) {
      this.status = AccountStatus_list_ValidValues[idx];
    } else {
      throw new Error("Unknown status of " + newValue);
    }
  }
  
  public getAccountStatusValidValues(): string[] {
    return AccountStatus_list_ValidValues;
  }
  ...
  */
  ...
  public addCoverage(newValue: AccountCoverage) {
    if (typeof(newValue) === 'undefined') {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteCoverageAll(): AccountCoverage[] {
    if (typeof(this.coverage) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteCoverageBySplice(start: number, deleteCount?: number): AccountCoverage[] {
    if (typeof(this.coverage) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getCoverageOrElse(defaultValue: AccountCoverage[]): AccountCoverage[] {
  ...
  */
  ...
  public addGuarantor(newValue: AccountGuarantor) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array guarantor, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteGuarantorAll(): AccountGuarantor[] {
    if (typeof(this.guarantor) !== 'undefined') {
       const oldArray = this.guarantor;
       delete this.guarantor;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array guarantor, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteGuarantorBySplice(start: number, deleteCount?: number): AccountGuarantor[] {
    if (typeof(this.guarantor) !== 'undefined') {
       return this.guarantor.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field guarantor.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field guarantor if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getGuarantorOrElse(defaultValue: AccountGuarantor[]): AccountGuarantor[] {
      if (this.guarantor == undefined || this.guarantor == null ) { return defaultValue; }
      return this.guarantor;
  }
