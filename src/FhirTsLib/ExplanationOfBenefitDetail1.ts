...
import { CodeableConcept, Element, ExplanationOfBenefitAdjudication, ExplanationOfBenefitSubDetail1, Extension, Money, Quantity } from './index';
...
export class ExplanationOfBenefitDetail1 {
  ...
  * @returns An array containing the elements that were deleted.
  */
  public deleteSubDetailAll(): ExplanationOfBenefitSubDetail1[] {
    if (typeof(this.subDetail) !== 'undefined') {
  ...
  *     was undefined.
  */
  public deleteSubDetailBySplice(start: number, deleteCount?: number): ExplanationOfBenefitSubDetail1[] {
    if (typeof(this.subDetail) !== 'undefined') {
  ...
  * @returns the value or the parameter value
  */
  public getSubDetailOrElse(defaultValue: ExplanationOfBenefitSubDetail1[]): ExplanationOfBenefitSubDetail1[] {
