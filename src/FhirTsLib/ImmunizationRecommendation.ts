 ...
 *    file:/Users/admin/Documents/DevNetbeans/jsonSchemaToJava/target/classes/schema/fhir.schema.json#/definitions/ImmunizationRecommendation
 */
export class ImmunizationRecommendation {
  ...
  protected recommendation?: ImmunizationRecommendationRecommendation[];
  ...
  */
  ...
  public addRecommendation(newValue: ImmunizationRecommendationRecommendation) {
    if (typeof(newValue) === 'undefined') {
  ...
  /**
  * Removes all elements from the array recommendation, returning the deleted elements.
  * @returns An array containing the elements that were deleted.
  */
  public deleteRecommendationAll(): ImmunizationRecommendationRecommendation[] {
    if (typeof(this.recommendation) !== 'undefined') {
       const oldArray = this.recommendation;
       delete this.recommendation;
       return oldArray;
    }
    return [];
  ...
  /**
  * Removes elements from the array recommendation, returning the deleted elements.
  * @param start The zero-based location in the array from which to start removing elements.
  * @param deleteCount The number of elements to remove.
  * @returns An array containing the elements that were deleted, or an empty array if the element
  *     was undefined.
  */
  public deleteRecommendationBySplice(start: number, deleteCount?: number): ImmunizationRecommendationRecommendation[] {
    if (typeof(this.recommendation) !== 'undefined') {
       return this.recommendation.splice(start, deleteCount);
    }
    return [];
  }
  
  /**
  * Gets the current value of field recommendation.
  * @returns the value  or undefined
  */
  ...
  /**
  * Gets the current value of field recommendation if it exists,
  * but if it is 'undefined' it will return the value supplied
  * as the parameter.
  * @returns the value or the parameter value
  */
  public getRecommendationOrElse(defaultValue: ImmunizationRecommendationRecommendation[]): ImmunizationRecommendationRecommendation[] {
      if (this.recommendation == undefined || this.recommendation == null ) { return defaultValue; }
      return this.recommendation;
  }
